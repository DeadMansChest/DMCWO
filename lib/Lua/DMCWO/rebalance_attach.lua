...
tweak_data.weapon.factory.parts.wpn_fps_aug_body_f90.stats = { value = 1, spread = 2, recoil = -4, concealment = -2 }
...
--MP5 10mm Mag 
tweak_factory.parts.wpn_fps_smg_mp5_m_straight.stats = { value = 1, extra_ammo = 0, damage = 2, recoil = -4 }
