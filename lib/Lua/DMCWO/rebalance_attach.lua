...
--Default = false
--NOTE: The AK74 and Gold AKM are excluded from this
...
tweak_factory.wpn_fps_pis_rage.override = {
	wpn_fps_upg_o_leupold = { stats = {} },
	wpn_fps_pis_c96_sight = { stats = {} },
}
...
tweak_factory.wpn_fps_lmg_rpk.override = deep_clone(deep_clone(tweak_factory.wpn_fps_pis_rage.override))
...
--tweak_factory.wpn_fps_fla_flamethrower_mk1.override = {} --The are you doing, Overkill?
...
if elcan_buis == true then
	...
	tweak_factory.parts.wpn_fps_upg_o_specter.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight","wpn_fps_upg_o_45iron" }
else
	tweak_factory.parts.wpn_fps_upg_o_specter.adds = { }
	tweak_factory.parts.wpn_fps_upg_o_specter.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
end
...
--Fire Breather
tweak_factory.parts.wpn_fps_upg_ns_ass_smg_firepig.stats = { value = 5, suppression = -3, recoil = 4, concealment = -2 }
...
--Funnel of Fun
tweak_factory.parts.wpn_fps_upg_ass_ns_linear.stats = { suppression = -5, spread = -2, concealment = -2, recoil = 6 }
...
tweak_factory.parts.wpn_fps_upg_ns_shot_shark.stats = { value = 5, suppression = -4, recoil = 4, concealment = -2 }
...
tweak_factory.parts.wpn_fps_pis_beretta_co_co1.stats = { value = 3, suppression = -5, spread_moving = 2, concealment = -2, recoil = 2 }
...
tweak_factory.parts.wpn_fps_upg_ak_b_draco.stats = { recoil = -1, damage = -0, concealment = 1, spread = 0, suppression = 0}
tweak_factory.parts.wpn_fps_upg_ak_b_draco.perks = { "fastest_ads_brl", "short_barrel" }

tweak_factory.parts.wpn_fps_upg_ass_ak_b_zastava.stats = { value = 1, spread = 5, recoil = -6, total_ammo_mod = -0, damage = 0, concealment = -4 }
...
tweak_factory.parts.wpn_fps_upg_ak_b_ak105.perks = { "fast_ads_brl", "short_barrel" }
tweak_factory.parts.wpn_fps_upg_ak_b_ak105.stats = { value = 1, spread = -1, recoil = 1, concealment = 1 }

--AR Medium Barrel (Para SMG)
tweak_factory.parts.wpn_fps_m4_uupg_b_medium.stats = { value = 1, damage = 1, spread = 2, concealment = -1 }
...
--Beowulf
tweak_factory.parts.wpn_fps_upg_ass_m4_b_beowulf.stats = { value = 1, spread = 5, recoil = -6, total_ammo_mod = -0, damage = 2, concealment = -4 }
...
tweak_factory.parts.wpn_fps_m4_uupg_b_sd.perks = { "slower_ads_brl", "silencer", "supp_barrel"}
...
tweak_factory.parts.wpn_fps_snp_r93_b_suppressed.perks = { "silencer", "slower_ads_brl", "supp_barrel" }
...
tweak_factory.parts.wpn_fps_sho_striker_b_suppressed.perks = { "silencer", "slower_ads_brl", "supp_barrel" }
...
--FAMAS Supp.	
tweak_factory.parts.wpn_fps_ass_famas_b_suppressed.perks = { "slower_ads_brl", "silencer", "supp_barrel" }
...
tweak_factory.parts.wpn_fps_smg_sterling_b_suppressed.perks = { "silencer", "slower_ads_brl", "supp_barrel" }
...
tweak_factory.parts.wpn_fps_ass_l85a2_b_short.stats = {value = 1, spread = 0, recoil = 2, concealment = 3, damage = -0}		

--VHS Suppresssed	
tweak_factory.parts.wpn_fps_ass_vhs_b_silenced.perks = { "slower_ads_brl" }
--VHS Sniper		
tweak_factory.parts.wpn_fps_ass_vhs_b_sniper.perks = { "slowest_ads_brl", "dmr_barrel" }	
tweak_factory.parts.wpn_fps_ass_vhs_b_sniper.stats = {value = 1, spread = 2, recoil = 0, concealment = -2, damage = 1}	
--VHS Short
...
------------------[[CUSTOM]]------------------{
--Single
tweak_factory.parts.wpn_fps_upg_i_singlefire.stats = { value = 5, spread = 4, recoil = 2 }
--Full-Auto
...
tweak_factory.parts.wpn_fps_m4_uupg_fg_lr300.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
--Competition (CAR-4)
...
tweak_factory.parts.wpn_fps_upg_fg_jp.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
--Gazelle (CAR-4)
tweak_factory.parts.wpn_fps_upg_fg_smr.stats = { spread = 1, recoil = 1, concealment = -2 }
tweak_factory.parts.wpn_fps_upg_fg_smr.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
--LOVA
...
tweak_factory.parts.wpn_fps_upg_ass_m4_fg_moe.forbids = { "wpn_fps_addon_ris", "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
...
tweak_factory.parts.wpn_fps_m16_fg_vietnam.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
--STAG
tweak_factory.parts.wpn_fps_upg_ass_m16_fg_stag.stats = { value = 1, recoil = 3, concealment = -3}
tweak_factory.parts.wpn_fps_upg_ass_m16_fg_stag.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
...
tweak_factory.parts.wpn_fps_upg_ak_fg_tapco.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
--AK Light Weight
...
tweak_factory.parts.wpn_fps_ass_ak5_fg_fnc.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
...
tweak_factory.parts.wpn_fps_smg_mp5_fg_mp5sd.forbids = { 
	"wpn_fps_upg_ns_ass_smg_large",
	"wpn_fps_upg_ns_ass_smg_medium",
	"wpn_fps_upg_ns_ass_smg_small",
	"wpn_fps_upg_ns_ass_smg_firepig",
...
tweak_factory.parts.wpn_fps_lmg_rpk_fg_standard.forbids = { "wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
...
tweak_factory.parts.wpn_fps_ass_l85a2_fg_short.stats = { value = 1, recoil = 2, concealment = 1 }
...
tweak_factory.parts.wpn_fps_upg_m4_g_ergo.stats = { value = 2, spread_moving = 2, spread = 4, recoil = -2}
--Pro Grip (Non-AK Rifles)
tweak_factory.parts.wpn_fps_upg_m4_g_sniper.stats = { value = 6, spread = 2, recoil = 2, spread_moving = -2, concealment = -1 }
--Rubber Grip (Non-AK Rifles)
tweak_factory.parts.wpn_fps_upg_m4_g_hgrip.stats = { value = 2, spread_moving = 2, recoil = 4, spread = 0 }
--Straight Grip
tweak_factory.parts.wpn_fps_upg_m4_g_mgrip.stats = { value = 2, spread_moving = 2, concealment = 2, spread = 1 }


--AK Rubber Grip
tweak_factory.parts.wpn_fps_upg_ak_g_hgrip.stats = { value = 2, spread_moving = -2, recoil = 1, concealment = 2 }
--AK Plastic Grip
tweak_factory.parts.wpn_fps_upg_ak_g_pgrip.perks = {"fast_ads_grip"}
tweak_factory.parts.wpn_fps_upg_ak_g_pgrip.stats = { value = 2, spread_moving = 2, spread = 2,  recoil = -1}
--AK Wood Grip
tweak_factory.parts.wpn_fps_upg_ak_g_wgrip.stats = { value = 2, spread_moving = 1, recoil = 2, concealment = -1, spread = 0 }

--SG552 Green Grip
tweak_factory.parts.wpn_fps_ass_s552_g_standard_green.stats = { value = 4, recoil = 1, concealment = -2 }

--Ergo Grip (HK21)
tweak_factory.parts.wpn_fps_lmg_hk21_g_ergo.stats = { value = 3, recoil = 1, spread_moving = 2, concealment = -1 }
...
--FAL SAW grip
tweak_factory.parts.wpn_fps_ass_fal_g_01.stats = { value = 2, recoil = 2, spread_moving = 1, concealment = 2 }
...
--Standard
tweak_factory.parts.wpn_fps_upg_m4_s_standard.stats = { value = 1, spread_moving = -1, concealment = -1, recoil = 1, spread = 1 }
--Tactical Stock
tweak_factory.parts.wpn_fps_upg_m4_s_pts.stats = { value = 3, spread = 1, spread_moving = 1, recoil = 1, concealment = -1 }
...
--M249 Solid Stock
tweak_factory.parts.wpn_fps_lmg_m249_s_solid.stats = { value = 3, recoil = 2, spread_moving = -2, concealment = -2 }
...
--MP9 Stock
tweak_factory.parts.wpn_fps_smg_mp9_s_skel.stats = { value = 5, recoil = 3, spread_moving = -3, concealment = -3, spread = 2 }
...
tweak_factory.parts.wpn_fps_upg_o_aimpoint.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }

--EOTech
tweak_factory.parts.wpn_fps_upg_o_eotech.stats = { value = 3, zoom = 3, recoil = 0, spread_moving = -2, concealment = -2 }
tweak_factory.parts.wpn_fps_upg_o_eotech.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_acog.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_eotech_xps.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }

--Aimpoint CS
tweak_factory.parts.wpn_fps_upg_o_cs.stats = { value = 5, zoom = 4, recoil = 0, spread_moving = -3, concealment = -1 }
tweak_factory.parts.wpn_fps_upg_o_cs.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_rx01.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_docter.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_t1micro.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_cmore.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_rx30.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_reflex.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_fps_upg_o_leupold.stats = {value = 8, zoom = 10, recoil = 3, spread_moving = -3, concealment = -3}
tweak_factory.parts.wpn_fps_upg_o_leupold.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight", "wpn_fps_ass_m16_os_frontsight" }
...
tweak_factory.parts.wpn_fps_pis_c96_sight.stats = { value = 1, zoom = 8, recoil = 2, concealment = -2}
tweak_factory.parts.wpn_fps_pis_c96_sight.forbids = { "wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight" }
...
tweak_factory.parts.wpn_upg_saiga_m_20rnd.stats = { value = 1, extra_ammo = 12 }
...
tweak_factory.parts.wpn_fps_upg_a_slug.stats = { value = 5, total_ammo_mod = -38, damage = 0, spread = 6, moving_spread = -5, recoil = -6 }
tweak_factory.parts.wpn_fps_upg_a_slug.custom_stats = { damage_far_mul = 3, rays = 1, armor_piercing_add = 1, can_shoot_through_enemy = true, can_shoot_through_shield = true, can_shoot_through_wall = true, ammo_pickup_min_mul = 0.8, ammo_pickup_max_mul = 0.9, damage_near_mul = 0.5 }
...
if sho_bird == true then
	tweak_factory.parts.wpn_fps_upg_a_custom_free.stats = { value = 5, damage = -12, spread = -4, recoil = 6, total_ammo_mod = 38 }
...
tweak_factory.wpn_fps_snp_m95.override.wpn_fps_upg_o_dd_front = { a_obj = "a_o"}		
...
tweak_factory.parts.wpn_fps_upg_o_ak_scopemount.override = {
	...
	wpn_fps_upg_o_specter = {
		...
		stance_mod = {
			wpn_fps_ass_74 = {
				translation = Vector3(0, 3.25, -4.6)
			},
			wpn_fps_ass_akm = {
				translation = Vector3(0, 3.25, -4.6)
			},
			...
			wpn_fps_smg_akmsu = {
				translation = Vector3(0, 3.25, -4.3)
			}
		}
	},		
	wpn_fps_extra_zoom = {
		...
		stance_mod = {
			wpn_fps_ass_74 = {
				translation = Vector3(0, 3.25, -4.6)+ Vector3( 0, 0 ,-3.15 )
			},
			wpn_fps_ass_akm = {
				translation = Vector3(0, 3.25, -4.6)+ Vector3( 0, 0 ,-3.15 )
			},
			...
			wpn_fps_smg_akmsu = {
				translation = Vector3(0, 3.25, -4.3)+ Vector3( 0, 0 ,-3.15 )
			}
		}
	},
	wpn_fps_upg_o_acog = {
		...
		stance_mod = {
			wpn_fps_ass_74 = {
				translation = Vector3(0, 5.25, -4.6)
			},
			wpn_fps_ass_akm = {
				translation = Vector3(0, 5.25, -4.6)
			},
			...
			wpn_fps_smg_akmsu = {
				translation = Vector3(0, 5.25, -4.3)
			}
		}
	},
...
tweak_factory.wpn_fps_lmg_rpk.override.wpn_fps_lmg_rpk_fg_standard = {
	forbids = {"wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg" }
}
...
tweak_factory.wpn_fps_ass_m16.override.wpn_fps_m4_uupg_s_fold = {stats = { value = 5, spread = 1, recoil = 0, concealment = 0}}
...
tweak_factory.wpn_fps_ass_m16.override.wpn_fps_upg_ass_m4_b_beowulf = {stats = { value = 1, spread = 4, recoil = -6, total_ammo_mod = -0, damage = 1, concealment = -4 }}
...
tweak_factory.wpn_fps_lmg_hk21.override.wpn_fps_snp_msr_ns_suppressor = { stats = { value = 5, suppression = 100, alert_size = 12, spread = 0, recoil = 0, spread_moving = -2, concealment = 0, damage = -1} }
tweak_factory.wpn_fps_ass_m14.override.wpn_fps_snp_msr_ns_suppressor = { stats = { value = 5, suppression = 100, alert_size = 12, spread = 0, recoil = 0, spread_moving = -2, concealment = 0, damage = -1} }
tweak_factory.wpn_fps_ass_fal.override.wpn_fps_snp_msr_ns_suppressor = { stats = { value = 5, suppression = 100, alert_size = 12, spread = 0, recoil = 0, spread_moving = -2, concealment = 0, damage = -1} }
tweak_factory.wpn_fps_ass_g3.override.wpn_fps_snp_msr_ns_suppressor = { stats = { value = 5, suppression = 100, alert_size = 12, spread = 0, recoil = 0, spread_moving = -2, concealment = 0, damage = -1} }
tweak_factory.wpn_fps_ass_galil.override.wpn_fps_snp_msr_ns_suppressor = { stats = { value = 5, suppression = 100, alert_size = 12, spread = 0, recoil = 0, spread_moving = -2, concealment = 0, damage = -1} }
