...
--Recoil Adjustments
RegisterScript("lib/Lua/DMCWO/recoil_fix.lua", 2, "lib/units/cameras/fpcameraplayerbase")
--Tactical Reloading
RegisterScript("lib/Lua/DMCWO/tact_reload.lua", 2, "lib/tweak_data/weapontweakdata")
RegisterScript("lib/Lua/DMCWO/tact_reload.lua", 2, "lib/units/weapons/raycastweaponbase")
RegisterScript("lib/Lua/DMCWO/tact_reload.lua", 2, "lib/units/weapons/shotgun/newshotgunbase")

--[[PERSIST SCRIPTS]]
AddPersistScript("RebalanceGen", "lib/Lua/DMCWO/rebalance_general.lua")
