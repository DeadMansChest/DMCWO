...
tweak_data.projectiles.dynamite.launch_speed = 200
...
local nades = {
'launcher_frag','launcher_incendiary',
'launcher_frag_m32','launcher_incendiary_m32',
'launcher_frag_china','launcher_incendiary_china',
}
...
tweak_data.projectiles.launcher_rocket.range = 300
tweak_data.projectiles.launcher_rocket.curve_pow = 1.75
...
--I love hardcoded values that can only be changed in tweak_data /a
