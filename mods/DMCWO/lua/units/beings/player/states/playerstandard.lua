...
function PlayerStandard:_check_action_steelsight(t, input)
	...
	elseif input.btn_steelsight_press or self._steelsight_wanted then
		if DMCWO.bipod_ads_autodeploy == true then
