...
Hooks:Add("LocalizationManagerPostInit", "localization_dmc", function(loc)
	...
	loc:add_localized_strings( {
		["dmc_menu_title"] = "DMCWO",
		["dmc_menu_desc"] = "Options for various aspects of DMCWO.\nUnless specified otherwise, all changes will be applied after the next loading screen.",
		
		["dmc_log_toggle_title"] = "stfu",
		["dmc_log_toggle_desc"] = "Disables the random console log spam upon loading.\nOff by default.",
		
		["dmc_skill_title"] = "Skill Settings",
		["dmc_skill_desc"] = "Options regarding player skills.",
		["dmc_skill_toggle_title"] = "Havel Mum Mode (Relaunch Required!!!)",
		["dmc_skill_toggle_desc"] = "Make that min-max/superman/godmode/babby/etc. build! (Vanilla-ish skills, 120 skillpoints, Infamy bonus).\nOff by default.",
		
		["dmc_weapons_title"] = "Weapon Settings",
		["dmc_weapons_desc"] = "Options regarding weapon/attachment behaviours.",
		["dmc_weapons_tracers_title"] = "Sniper Tracers",
		["dmc_weapons_tracers_desc"] = "Makes snipers make use of the PD:TH sniper tracers.\nOff by default.",
		["dmc_weapons_light_show_title"] = "Tracer Light Show",
		["dmc_weapons_light_show_desc"] = "Makes ALL raycast firing weapons make use of the PD:TH sniper tracers.\nOff by default.",
		--
		["dmc_weapons_bipod_swivel_title"] = "Disable Bipod Swivel",
		["dmc_weapons_bipod_swivel_desc"] = "Smooths the bipod ADS transition by disabling the swivel effect when looking around deployed.\nOff by default.",
		["dmc_weapons_bipod_autodeploy_title"] = "Bipod ADS Autodeploy",
		["dmc_weapons_bipod_autodeploy_desc"] = "If all bipod deployment checks are good, you will auto-deploy your bipod when you aim.\nOff by default.",
		["dmc_weapons_bipod_undeploy_title"] = "Bipod Movement Undeploy",
		["dmc_weapons_bipod_undeploy_desc"] = "Pressing a move key (i.e. WASD) will now un-deploy your bipod.\nOff by default.",
		
		["dmc_string_title"] = "String Settings",
		["dmc_string_desc"] = "Options regarding in-game strings.",
		["dmc_string_realnames_title"] = "Real Weapon & Mod Names",
		["dmc_string_realnames_desc"] = "Renames weapons & mods to their IRL counter parts.\nOn by default.",
		--
		["dmc_string_sillynames_title"] = "Other String Toggles",
		["dmc_string_sillynames_desc"] = "The below options will take priority over \"Real Weapon & Mod Names\".",
		["dmc_string_upotte_title"] = "\"Upotte!!\" Names",
		["dmc_string_upotte_desc"] = "Renames weapons to reference \"Upotte!!\".\nOff by default.",
		["dmc_string_ocelot_title"] = "Revolver Ocelot",
		["dmc_string_ocelot_desc"] = "Revolver Ocelot (Revolver Ocelot).\nOff by default.",
		
		
		["dmc_attach_title"] = "Attachment Settings",
		["dmc_attach_desc"] = "Options primarily regarding the visuals of attachments.",
		["dmc_attach_hide_brakes_title"] = "Hide Rifle/MG Brakes",
		["dmc_attach_hide_brakes_desc"] = "Hides rifle/MG brakes.\nOff by default.",
		["dmc_attach_hide_sg_brakes_title"] = "Hide Shotgun Brakes",
		["dmc_attach_hide_sg_brakes_desc"] = "Hides shotgun brakes.\nOff by default.",
		["dmc_attach_hide_pis_flash_title"] = "Hide Pistol Flash Hider",
		["dmc_attach_hide_pis_flash_desc"] = "Hides the pistol flash hider.\nOff by default.",
		--
		["dmc_attach_buis_swap_title"] = "Magpul BUIS Swap",
		["dmc_attach_buis_swap_desc"] = "If enabled, swaps out the Magpul BUIS for the default KSG sights.\nOff by default.",
		--
		["dmc_attach_weapon_specific_title"] = "Weapon Specific Options",
		["dmc_attach_weapon_specific_desc"] = "The below options only apply to certain attachments for a weapon.",
		--
		["dmc_attach_s552_title"] = "SIG SG 552-2",
		["dmc_attach_s552_desc"] = "Options for the SIG SG 552-2's attachments",
		["dmc_attach_s552_rear_title"] = "Alternate Rear Iron Sight",
		["dmc_attach_s552_rear_desc"] = "Swaps out the rear iron sight with the pistol rear sight.\nOff by default.",
		["dmc_attach_s552_handguard_title"] = "Swap Handguard Colors",
		["dmc_attach_s552_handguard_desc"] = "Swaps the color of the black and green handguards.\nOff by default.",
		["dmc_attach_s552_stock_title"] = "Swap Stock Colors",
		["dmc_attach_s552_stock_desc"] = "Swaps the color of the black and green stocks.\nOff by default.",
		["dmc_attach_s552_grip_title"] = "Swap Grip Colors",
		["dmc_attach_s552_grip_desc"] = "Swaps the color of the black and green grips.\nOff by default.",
		--
		["dmc_attach_m95_title"] = "Barret M95",
		["dmc_attach_m95_desc"] = "Options for the Barret M95's attachments",
		["dmc_attach_m95_bipod_title"] = "Hide Bipod",
		["dmc_attach_m95_bipod_desc"] = "Hide the M95's bipod.\nOff by default.",
		...
		["bm_wp_wpn_fps_upg_sr3m_unimax_desc"] = "Laser that can be toggled on and off by pressing $BTN_GADGET.\n\n##15% tighter## hipfire while the ##laser is on.##",
		["bm_wp_wpn_fps_pis_qs_las_desc"] = "Laser that can be toggled on and off by pressing $BTN_GADGET.\n\n##15% tighter## hipfire while the ##laser is on.##",
		
		["bm_wp_wpn_fps_upg_l115_anpeq2_desc"] = "Laser/flashlight that can be toggled on and off by pressing $BTN_GADGET.\n\n##15% tighter## hipfire while the ##laser is on.##",
		...
		--{
			...
			--{
				...
				["menu_shotgun_cqb_desc"] = "BASIC: ##$basic##\nYou reload shotguns ##10%## faster.\n\nACE: ##$pro##\nYou reload shotguns ##25%## faster. You gain a ##50%## increased steel sight speed when using shotguns.",
		...
		--{
			...
			--{
				...
				["menu_steady_grip_dmc"] = "Sharpshooter",
				...
				["menu_shock_and_awe_dmc"] = "Nerves of Steel",
...
function LocalizationManager:text(string_id, ...)
	...
	--[[ WE UPOTTE NAO ]]--{
	--[ Faculty ]
	or DMCWO._data.upotte == true and string_id == "bm_w_m1928" and "Thompson-sensei"
	or DMCWO._data.upotte == true and string_id == "bm_w_m1928_desc" and "An American elementary school teacher working at Seishou Academy. She's chambered in .45 ACP.\nCheerful but airheaded.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--[ Elementary Schoolers ]
	--MP5
	or DMCWO._data.upotte == true and string_id == "bm_w_mp5" and "Empi"
	or DMCWO._data.upotte == true and string_id == "bm_w_mp5_desc" and "A German elementary schooler attending Seishou Academy. She's chambered in 9x19mm.\nPresident of the elementary school student council.\nCan pierce thin walls.\n\nCan switch between full-auto, 3-rnd burst and semi-auto."
	--M10
	or DMCWO._data.upotte == true and string_id == "bm_w_mac10" and "Emten"
	or DMCWO._data.upotte == true and string_id == "bm_w_mac10_desc" and "An American elementary schooler attending Seishou Academy. She's chambered in .45 ACP.\nMotor-mouthed and quite \"stacked\".\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--[ Middleschoolers ]
	--AUG
	or DMCWO._data.upotte == true and string_id == "bm_w_aug" and "AUG"
	or DMCWO._data.upotte == true and string_id == "bm_w_aug_desc" and "An Austrian middleschooler attending Seishou Academy. She's chambered in 5.56 NATO.\nStrict but reserved.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--M16
	or DMCWO._data.upotte == true and string_id == "bm_w_m16" and "Ichiroku"
	or DMCWO._data.upotte == true and string_id == "bm_w_m16_desc" and "An American middleschooler attending Seishou Academy. She's chambered in 5.56 NATO.\nEnergetic and foul-mouthed.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--L85
	or DMCWO._data.upotte == true and string_id == "bm_w_l85a2" and "Eru"
	or DMCWO._data.upotte == true and string_id == "bm_w_l85a2_desc" and "A British middleschooler attending Seishou Academy. She's chambered in 5.56 NATO.\nShy and clumsy.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--M4A1
	or DMCWO._data.upotte == true and string_id == "bm_w_m4" and "Em-Four"
	or DMCWO._data.upotte == true and string_id == "bm_w_m4_desc" and "An American middleschooler attending Seishou Academy. She's chambered in 5.56 NATO.\nVice-president of the middleschool student council.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--AK74
	or DMCWO._data.upotte == true and string_id == "bm_w_ak74" and "AK74"
	or DMCWO._data.upotte == true and string_id == "bm_w_ak74_desc" and "A Russian middleschooler attending Red Steel Academy. She's chambered in 5.45x39.\nSerious and cunning.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--AKM
	or DMCWO._data.upotte == true and string_id == "bm_w_akm" and "AKM"
	or DMCWO._data.upotte == true and string_id == "bm_w_akm_desc" and "A Russian middleschooler attending Red Steel Academy. She's chambered in 7.62x39.\nMenacing and a bully.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--RPK
	or DMCWO._data.upotte == true and string_id == "bm_w_rpk" and "RPK"
	or DMCWO._data.upotte == true and string_id == "bm_w_rpk_desc" and "A Russian middleschooler attending Red Steel Academy. She's chambered in 7.62x39.\nAgressive but rather simple minded.\nCan pierce enemies and walls."
	--[ Highschoolers ]
	--G3
	or DMCWO._data.upotte == true and string_id == "bm_w_g3" and "Jiisuri"
	or DMCWO._data.upotte == true and string_id == "bm_w_g3_desc" and "A German highschooler attending Seishou Academy. She's chambered in 7.62 NATO.\nElegant but a bit of a klutz.\nCan pierce enemies, walls and shields.\nDMC's raifu, treat her well.\n\nCan switch between full-auto and semi-auto."
	--M14
	or DMCWO._data.upotte == true and string_id == "bm_w_m14" and "Ichiyon"
	or DMCWO._data.upotte == true and string_id == "bm_w_m14_desc" and "An American highschooler attending Seishou Academy. She's chambered in 7.62 NATO.\nCarefree and filled with puns.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto."
	--FAL
	or DMCWO._data.upotte == true and string_id == "bm_w_fal" and "Faaru"
	or DMCWO._data.upotte == true and string_id == "bm_w_fal_desc" and "A Belgian highschooler attending Seishou Academy. She's chambered in 7.62 NATO.\nResponsible and lax.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto."
	--}
	
	--[[ REVOLVER OCELOT ]]--{
	--[[REVOLVER OCELOT]]
	or DMCWO._data.ocelot == true and string_id == "bm_w_peacemaker" and "Revolver Ocelot"
	...
	--Long
	or DMCWO._data.ocelot == true and string_id == "bm_wp_peacemaker_barrel_long" and "12\" Revolver Ocelot"
	or string_id == "bm_wp_peacemaker_barrel_long_desc" and "##20% longer## Revolver Ocelot.\n##5% slower## Revolver Ocelot."
	--Short
	or DMCWO._data.ocelot == true and string_id == "bm_wp_peacemaker_barrel_short" and "5.5\" Revolver Ocelot"
	or string_id == "bm_wp_peacemaker_barrel_short_desc" and "##10% shorter## Revolver Ocelot.\n##5% faster## Revolver Ocelot." 
	--Grip
	or DMCWO._data.ocelot == true and string_id == "bm_wp_peacemaker_handle_bling" and "Engraved Revolver Ocelot Grips"
	--Stock
	or DMCWO._data.ocelot == true and string_id == "bm_wp_peacemaker_rifle_stock" and "Revolver Ocelot Stock"
	--}
	
	--[[BRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m134" and "General Electric M134"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m134_barrel_extreme" and "Anti-Air Barrel"
	or string_id == "bm_wp_m134_barrel_extreme_desc" and "##15% longer## overall range.\n##10% slower## ADS speeds.\n##15% slower## movement."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m134_barrel_short" and "Compact Barrel"
	or string_id == "bm_wp_m134_barrel_short_desc" and "##25% shorter## overall range.\n##10% faster## ADS speeds.\n##20% faster## movement."
	
	--[[WE TERRORIST NAO]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_rpg7" and "Bazalt RPG-7"
	...
	--[[GOLD SLAVSHIT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_akm_gold" and "Gold Plated AKMS"
	or string_id == "bm_w_akm_gold_desc" and "A Russian gold-plated assault rifle chambered in 7.62x39mm.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	
	--[[JAM733]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_amcar" and "Colt M733 Commando"
	or string_id == "bm_w_amcar_desc" and "An American carbine chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto.\nBenefits from rifle skills."
	
	--[[STEEL BALLS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_ak74" and "Concern Kalashnikov AKS-74"
	or string_id == "bm_w_ak74_desc" and "A Russian assault rifle chambered in 5.45x39mm.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	
	--[[JAM-4]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m4" and "Colt M4A1" --"Safety Pins"
	...
	--Suppressed Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_uupg_b_sd" and "Suppressed Barrel" 
	or string_id == "bm_wp_m4_uupg_b_sd_desc" and "##Internally suppressed## barrel.\nReduces the weapon's sound radius to ##2 meters.\n10% slower## ADS speeds." 
	--Aftermarket
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_uupg_fg_lr300" and "LR300 Handguard"
	or string_id == "bm_wp_m4_uupg_fg_lr300_desc" and "##7.5% faster## ADS speeds."
	--Competition
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fg_jp" and "JPE Modular Handguard"
	or string_id == "bm_wp_upg_fg_jp_desc" and "##5% faster## ADS speeds." 
	--Gazelle
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fg_smr" and "Geissele Super Modular Rail"
	
	--[[AUGLY]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_aug" and "Steyr AUG A2"
	or string_id == "bm_w_aug_desc" and "An Austrian bullpup assault rifle chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--A3 Tact. Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_aug_fg_a3" and "A3 Rail"
	...
	--[[WHITE FLAG]] -- :^)
	or DMCWO._data.reelnames == true and string_id == "bm_w_famas" and "Nexter FAMAS F1" --"IS THAT A DEAGLE?"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_famas_b_sniper" and "G2 Sniper Barrel"
	or string_id == "bm_wp_famas_b_sniper_desc" and "##Sniper class barrel.##\n##30% longer## overall range.\n##10% greater## minimum damage.\n##10% slower## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_famas_b_short" and "G2 Commando Barrel" 
	...
	--Retro Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_famas_g_retro" and "G1 Kit"
	or string_id == "bm_wp_famas_g_retro_desc" and "ROF ##raised## to ##1200 RPM##"
	
	--[[JAM]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_l85a2" and "BAE L85A2" --"Eru"
	or string_id == "bm_w_l85a2_desc" and "A British-German bullpup assault rifle chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_l85a2_b_long" and "Long Barrel"
	or string_id == "bm_wp_l85a2_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_l85a2_b_short" and "Short Barrel"
	or string_id == "bm_wp_l85a2_b_short_desc" and "##15% shorter## overall range.\n##5% faster## ADS speeds." 
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_l85a2_g_worn" and "Taped Pistol Grip"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_l85a2_fg_short" and "Daniel Defense L85 Quad Rail"
	or string_id == "bm_wp_l85a2_fg_short_desc" and "##5% faster## ADS speeds." 
	
	--[[CROATGAT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_vhs" and "HS Produkt VHS-2"
	or string_id == "bm_w_vhs_desc" and "A Croatian bullpup assault rifle chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_vhs_b_short" and "Short Barrel"
	or string_id == "bm_wp_vhs_b_short_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds." 
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_vhs_b_sniper" and "Sniper Barrel"
	or string_id == "bm_wp_vhs_b_sniper_desc" and "##Sniper class barrel.##\n##30% longer## overall range.\n##10% greater## minimum damage.\n##10% slower## ADS speeds."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_vhs_b_silenced" and "Suppressed Barrel"
	or string_id == "bm_wp_vhs_b_silenced_desc" and "##Internally suppressed## barrel.\nReduces the weapon's sound radius to ##2 meters.\n##10% slower## ADS speeds."
	
	--[[SLAVSHIT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_akm" and "Concern Kalashnikov AKMS"
	or string_id == "bm_w_akm_desc" and "A Russian assault rifle chambered in 7.62x39mm.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
		
	--[[MELTGUN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_g36" and "Heckler & Koch G36K"
	...
	--Compact
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g36_fg_c" and "G36c Kit"
	or string_id == "bm_wp_g36_fg_c_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds."
	--Polizei
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g36_fg_ksk" and "Knights Armament Co. RAS Handguard"  
	--Solid Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g36_s_kv" and "G36KV Stock"
	--Sniper Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g36_s_sl8" and "SL8 Stock"
	
	--[[PUNS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m14" and "Springfield M14 DMR"
	or string_id == "bm_w_m14_desc" and "A special DMR version of the American M14 battle rifle chambered in 7.62 NATO.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto."
	--Abraham
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m14_body_ebr" and "MK.14 Kit"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m14_body_jae" and "M14 JAE Kit"
	
	--[[SWED]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_ak5" and "Bofors Ak 5" --"FNC's sexy swedish cousin"
	or string_id == "bm_w_ak5_desc" and "A licensed Swedish copy of the Belgian FN FNC assault rifle, chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--Karbin Ceres
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak5_fg_ak5c" and "Ak 5c Kit"
	or string_id == "bm_wp_ak5_fg_ak5c_desc" and "ROF ##lowered## to ##650 RPM.##"
	--Belgian Heat
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak5_fg_fnc" and "FN FNC Kit"
	or string_id == "bm_wp_ak5_fg_fnc_desc" and "Allows for firing in ##3-rounds bursts.##\nROF ##raised## to ##725 RPM.##"
	--Bertil
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak5_s_ak5b" and "Ak 5b Stock"
	--Caesar
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak5_s_ak5c" and "Ak 5c Stock"
	
	--[[JAM16]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m16" and "Colt M16A4" --"Orange Slices", "IS THAT A FAMAS?"
	or string_id == "bm_w_m16_desc" and "An American 5.56 NATO assault rifle.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--Railed
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m16_fg_railed" and "Daniel Defense Lite Rail" --not a carbon copy, just based off of, if only for the delta ring dongle thing
	or string_id == "bm_wp_m16_fg_railed_desc" and "##5% slower## ADS speeds."
	--Blast to the Past
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m16_fg_vietnam" and "M16A1 Handguard"
	or string_id == "bm_wp_m16_fg_vietnam_desc" and "##5% faster## ADS speeds." 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m16_s_solid" and "M16 Stock"
	or string_id == "bm_wp_m16_s_solid" and "Solid Stock"
	
	--[[553 NO PANTSU]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_s552" and "SIG SG 552-2" --"SG550's Little Sister"
	or string_id == "bm_w_s552_desc" and "A Swiss-made carbine chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto, 3-rnd burst and semi-auto.\nBenefits from rifle skills."
	--Enhanced Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_fg_standard_green" and "OD Green Handguard"
	--Enhanced Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_g_standard_green" and "OD Green Pistol Grip"
	--Enhanced Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_s_standard_green" and "OD Green Stock"	
	--Enhanced Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_fg_black" and "Black Handguard"
	--Enhanced Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_g_black" and "Black Pistol Grip"
	--Enhanced Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_s_black" and "Black Stock"
	--Railed Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_fg_railed" and "SIG Railed Handguard" --pretty sure Sig manufactures their own rails for the 552/3. Can't be bothered to look :/
	--Heat Treated
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ass_s552_body_standard_black" and "Black Receiver" --GJ, Overkill. Heat treating metal, while it does make it harder, also makes it more brittle. Pretty sure you don't want that in a gun
	--Long Barrel
	or string_id == "bm_wp_ass_s552_b_long_desc" and "##15% longer## overall range.\n5##% slower## ADS speeds."
	
	--[[EAG-H]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_scar" and "FN MK.17"
	or string_id == "bm_w_scar_desc" and "A Belgian-American battle rifle chambered in 7.62 NATO.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto.\n\n\"Gee Squid, why does your mom let you have two SCARs?\""
	--Sniper Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_scar_s_sniper" and "MK.20 Stock"	
	...
	--Rail Extension
	or DMCWO._data.reelnames == true and string_id == "bm_wp_scar_fg_railext" and "PWS SCAR Rail Extension"
	or string_id == "bm_wp_scar_fg_railext_desc" and "##2.5% slower## ADS speeds."
	
	--[[RIGHT ARM]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_fal" and "FN FAL"
	or string_id == "bm_w_fal_desc" and "A Belgian battle rifle chambered in 7.62 NATO.\nCan pierce enemies, walls and shields.\n\"Right arm of the free world.\"\n\nCan switch between full-auto and semi-auto."
	--CQB
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_body_standard" and "DSA SA58 Handguard w/Short Barrel" --this might conflict with something since this is also the name_id of the receiver
	or string_id == "bm_wp_fal_body_standard_desc" and "##15% shorter## overall range.\n##5% faster## ADS speeds.\n##5% faster## movement."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_fg_03" and "IMI Romat Handguard"
	or string_id == "bm_wp_fal_fg_03_desc" and "##5% slower## ADS speeds."
	--Marksman
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_fg_04" and "DSA Freefloat Handguard"
	--or string_id == "bm_wp_fal_fg_04_desc" and "##5% faster## ADS speeds." 
	--Wood
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_fg_wood" and "Wooden Handguard"
	or string_id == "bm_wp_fal_fg_wood_desc" and "##7.5% slower## ADS speeds.\n##5% slower## movement."
	--Tactical Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_g_01" and "Tapco FAL/SAW Pistol Grip"
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_m_01" and "30rnd FAL Magazine"
	or string_id == "bm_wp_fal_m_01_desc" and "##10% slower## reload speeds."
	--Folding
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_s_01" and "Sidefolding Stock"
	--Marksman
	or DMCWO._data.reelnames == true and string_id == "bm_wp_fal_s_03" and "Magpul FAL PRS Stock"
	
	--[[BOTTLE OPENER]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_galil" and "IMI Galil ARM"
	or string_id == "bm_w_galil_desc" and "An Israeli battle rifle chambered in 7.62 NATO.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto."
	--Sniper
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_fg_sniper" and "IMI Galatz Handguard & Sniper Barrel"
	or string_id == "bm_wp_galil_fg_sniper_desc" and "##Sniper class barrel.##\n##30% longer## overall range.\n##10% greater## minimum damage.\n##10% slower## ADS speeds.\nROF ##lowered## to ##630 RPM.##"
	--Light
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_fg_sar" and "IMI Galil SAR Handguard & 13\" Barrel"
	or string_id == "bm_wp_galil_fg_sar_desc" and "##5% faster ADS## speeds." 
	--CQB
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_fg_mar" and "IMI Galil MAR Handguard & 7\" Barrel"
	or string_id == "bm_wp_galil_fg_mar_desc" and "##10% shorter## overall range.\n##15% faster## ADS speeds.\n##10% faster## movement.\nROF ##raised## to ##720 RPM.##"
	--FAB
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_fg_fab" and "FAB Defense VFR GA Handguard"
	--Sniper Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_g_sniper" and "IMI Galatz Pistol Grip"
	--Sniper Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_s_sniper" and "IMI Galatz Wooden Stock"
	--Skeletal Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_s_skeletal" and "IMI Galil MAR Stock"
	--Light Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_s_light" and "IMI Galatz Skeleton Stock"
	--FAB Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_galil_s_fab" and "FAB Defense MG-CP Cheek Pad"
	
	--[[MAI RAIFU (SHE'S MINE I TELL YOU)]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_g3" and "Heckler & Koch G3A3"
	or string_id == "bm_w_g3_desc" and "A German battle rifle based off the Spanish CETME rifle, chambered in 7.62 NATO.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto."
	--Assault Kit
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_b_short" and "Short Barrel"
	or string_id == "bm_wp_g3_b_short_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds." 
	--DMR Kit
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_b_sniper" and "PSG-1 Barrel"
	or string_id == "bm_wp_g3_b_sniper_desc" and "##Sniper class barrel.##\n##30% longer## overall range.\n##25% greater## minimum damage.\n##10% slower## ADS speeds."
	--PSG Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_fg_psg" and "PSG-1 Handguard"
	or string_id == "bm_wp_g3_fg_psg_desc" and "##5% slower## ADS speeds."
	--Railed Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_fg_railed" and "FAB Defense G3-RS Handguard"
	--Retro Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_fg_retro" and "Wooden Slimline Handguard"
	or string_id == "bm_wp_g3_fg_retro_desc" and "##7.5% slower## ADS speeds.\n##5% faster## movement."
	--Plastic Retro Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_fg_retro_plastic" and "Slimline Handguard"
	or string_id == "bm_wp_g3_fg_retro_plastic_desc" and "##5% faster## ADS speeds.\n##10% faster## movement."
	--Retro Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_g_retro" and "G3 Ergo Grip"
	or string_id == "bm_wp_g3_g_retro_desc" and "##5% faster## ADS speeds." 
	--Sniper Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_g_sniper" and "PSG-1 Wooden Pistol Grip"
	--Sniper Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g3_s_sniper" and "PSG-1 Stock"

	
	--[[MSR]]	
	or DMCWO._data.reelnames == true and string_id == "bm_w_msr" and "Remington MSR"
	or string_id == "bm_w_msr_desc" and "An American bolt-action rifle chambered in 7.62 NATO.\nCan pierce enemies, walls and shields."
	--Suppressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_snp_msr_ns_suppressor" and "AAC TiTAN-QD Suppressor"
	...
	--Aluminum Body
	or DMCWO._data.reelnames == true and string_id == "bm_wp_msr_body_msr" and "MSR Aluminum Stock & Receiver"
	or string_id == "bm_wp_msr_body_msr_desc" and "##5% faster## ADS speeds." 
		
	--[[R93]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_r93" and  "Blaser R93 Tactical 2"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r93_b_suppressed" and  "Harvester Big Bore 338 Suppressor"
	or string_id == "bm_wp_r93_b_suppressed_desc" and  "A ##large## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n40% shorter## overall range.\n##10% slower## ADS speeds."
	--Wooden Body
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r93_body_wood" and "Long Range Sporter 2 Stock"
	or string_id == "bm_wp_r93_body_wood_desc" and "##2.5% slower## ADS speeds."
	
	--[[FIDDY CAL]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m95" and "Barrett M95"
	...
	--Tank Buster
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m95_b_barrel_long" and "Long Barrel w/AW50F Muzzle Brake"
	...
	--[[MOIST NUGGET]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_mosin" and "Mosin Nagant M91/30"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mosin_b_sniper" and "Nagant Suppressor"--"\"Bramit\" Device"
	or string_id == "bm_wp_mosin_b_sniper_desc" and "A ##large## 7.62x54R suppressor.\n##20% shorter## overall range.\nReduces the weapon's sound radius to ##2 meters.\n7.5% slower## ADS speeds."
	--Black Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mosin_body_conceal" and "Black Synthetic Stock"
		
	--[[ELMER FUDD]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_huntsman" and "Mosconi Coach Gun"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_huntsman_b_short" and "Sawn-Off Short Barrel"
	or string_id == "bm_wp_huntsman_b_short_desc" and "##20% shorter## overall range.\n##5% faster## ADS speeds." 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_huntsman_s_short" and "Sawn-Off Stock"
	
	--[[BARDODA SHOTGAT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_b682" and "Beretta 682"
	or string_id == "bm_w_b682_desc" and "An Italian, over-under, break-action shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_b682_b_short" and "Sawn-Off Short Barrel"
	or string_id == "bm_wp_b682_b_short_desc" and "##20% shorter## overall range.\n##5% faster## ADS speeds." 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_b682_s_short" and "Sawn-Off Stock"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_b682_s_ammopouch" and "Ammo Pouch"
	
	--[[870]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_r870" and "Remington Model 870" --"Remafdng"
	or string_id == "bm_w_r870_desc" and "An American, tube fed, pump-action shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r870_m_extended" and "R870 Lighter Magazine Spring"
	or string_id == "bm_wp_r870_m_extended_desc" and "##5% faster## reload speeds."
	--Zombie Hunter
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r870_fg_wood" and "Wooden Pump"
	or string_id == "bm_wp_r870_fg_wood_desc" and "##5% slower## ADS speeds."
	--Short Enough **don't know
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r870_s_nostock" and "No Stock"
	--Short Enough Tact. **don't know
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r870_s_nostock_big" and "No Stock w/Full Length Rail"
	--Govt. Stock **don't know
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r870_s_solid_big" and "Fixed Stock w/Full Length Rail"
	
	--[[CATS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_saiga" and "Concern Kalashnikov Saiga-12K"
	...
	--Tact. Russian
	or DMCWO._data.reelnames == true and string_id == "bm_wp_saiga_fg_lowerrail" and "Ultimak AK Modular Rail Forend System"
	or string_id == "bm_wp_saiga_fg_lowerrail_desc" and "##5% slower## ADS speeds."
	--Saiga 20 rounder
	or DMCWO._data.reelnames == true and string_id == "bm_wp_saiga_m_20rnd" and "20rnd MD Arms Saiga Drum"
	or string_id == "bm_wp_saiga_m_20rnd_desc" and "##15% slower## reload speeds."
	
	--[[AA12]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_aa12" and "MPS Auto Assault-12 CQB"
	or string_id == "bm_w_aa12_desc" and "An American, magazine fed, fully automatic shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_aa12_mag_drum" and "20rnd AA-12 Drum"
	...
	--[[M1014]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_benelli" and "Benelli M4"
	or string_id == "bm_w_benelli_desc" and "An Italian, tube fed, semi-automatic shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	--Long Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ben_b_long" and "Long Barrel w/7-Shot Tube"
	or string_id == "bm_wp_ben_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds."
	--Short Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ben_b_short" and "NFA Barrel w/4-Shot Tube"
	or string_id == "bm_wp_ben_b_short_desc" and "##20% shorter## overall range.\n##5% faster## ADS speeds." 
	--Collapsed Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ben_s_collapsed" and "M1014 Collapsed Stock"
	--Solid Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ben_fg_standard" and "M1014 Solid Stock" --same deal with the FAL, possible conflict
	
	--[[KELTEC]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_ksg" and "Kel-Tec KSG"
	or string_id == "bm_w_ksg_desc" and "An American, dual tube fed, pump-action bullpup shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	--Long Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ksg_b_long" and "Long Barrel w/2x 8-Shot Tubes"
	or string_id == "bm_wp_ksg_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds."
	--Short Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ksg_b_short" and "Patrol Barrel w/2x 6-Shot Tubes"
	or string_id == "bm_wp_ksg_b_short_desc" and "##15% shorter## overall range.\n##5% faster## ADS speeds." 
	
	--[[WHY DON'T YOU TAKE A SEAT OVER THERE?]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_spas12" and "Franchi SPAS-12"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_spas12_b_long" and "SPAS-12 8-Shot Tube Magazine"
	or string_id == "bm_wp_spas12_b_long_desc" and "##5% slower## ADS speeds."
	
	--[[STREET SWEEPER]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_striker" and "Armsel Striker"
	or string_id == "bm_w_striker_desc" and "A South-African, cylinder fed, semi-automatic shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_striker_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	or string_id == "bm_wp_striker_b_suppressed_desc" and "##Internally suppressed## barrel.\nReduces the weapon's sound radius to ##2 meters.\n10% slower## ADS speeds." 
	
	--[[BABBY 870]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_serbu" and "Short Remington Model 870"
	or string_id == "bm_w_serbu_desc" and "An American, tube fed, pump-action shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_shorty_m_extended_short" and "R870 Light Magazine Spring"
	or string_id == "bm_wp_shorty_m_extended_short_desc" and "##2.5% faster## reload speeds."
	--Standard
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r870_s_solid" and "Fixed Stock"
	--Police Shorty
	or DMCWO._data.reelnames == true and string_id == "bm_wp_serbu_s_solid_short" and "Fixed Stock w/Rail"
	--Tactical Shorty
	or DMCWO._data.reelnames == true and string_id == "bm_wp_serbu_s_nostock_short" and "No Stock w/Rail"
	
	--[[LONGCAT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_rpk" and "Concern Kalashnikov RPK"
	or string_id == "bm_w_rpk_desc" and "A Russian LMG chambered in 7.62x39mm.\nCan pierce enemies and walls."
	--Tactical Forgrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_rpk_fg_standard" and "Polymer Handguard"
	or string_id == "bm_wp_rpk_fg_standard_desc" and "##5% faster## ADS speeds." 
	--Plastic Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_rpk_s_standard" and "Polymer Stock"
	
	--[[KSP]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m249" and "FN Paratrooper M249"
	or string_id == "bm_w_m249_desc" and "A Belgian-American LMG chambered in 5.56 NATO.\nCan pierce enemies and walls."
	--Railed Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m249_fg_mk46" and "MK.46 Handguard"
	or string_id == "bm_wp_m249_fg_mk46_desc" and "##5% slower## ADS speeds."
	--Solid Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m249_s_solid" and "M249 Solid Stock"
	--LB
	or string_id == "bm_wp_m249_b_long_desc" and "##10% longer## overall range.\n##5% slower## ADS speeds."
	
	--[[RELATED TO RAIFU]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_hk21" and "Heckler & Koch HK21E" --"Related to mai raifu"
	or string_id == "bm_w_hk21_desc" and "A German GPMG chambered in 7.62 NATO.\nCan pierce enemies, walls and shields."
	--Short Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_hk21_fg_short" and "HK21 Short Handguard"
	or string_id == "bm_wp_hk21_fg_short_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds.\n##10% faster## movement."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_hk21_g_ergo" and "HK21 Ergo Grip"
	...
	--[[KERBEROS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_mg42" and "Mauser Maschinengewehr 42"
	or string_id == "bm_w_mg42_desc" and "A German GPMG chambered in 7.92x57mm.\nCan pierce enemies, walls and shields.\n\n\"And then the wolf... ate up Little Red Riding Hood\""
	--Light Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mg42_b_mg34" and "Maschinengewehr 34 Barrel"
	or string_id == "bm_wp_mg42_b_mg34_desc" and "##5% faster## ADS speeds.\nROF ##lowered## to ##900 RPM.##"
	--Heat Sink (Star Wars)
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mg42_b_vg38" and "BlasTech DLT-19 Barrel"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_w_par" and "FN M240B"
	or string_id == "bm_w_par_desc" and "A Belgian GPMG chambered in 7.62 NATO.\nCan pierce enemies, walls and shields."
	--Plastic Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_par_s_plastic" and "M240B Stock"
	--SB
	or DMCWO._data.reelnames == true and string_id == "bm_wp_par_b_short_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds."
	
	--[[GORDON]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_usp" and "Heckler & Koch USP Tactical"
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_usp" and "Akimbo H&K USP Tacticals"
	...
	--Velocity .45
	or DMCWO._data.reelnames == true and string_id == "bm_wp_usp_co_comp_2" and "SJC Compensator .45" --Technically only for the G17 but "Overkill logic" so yeah
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_usp_m_extended" and "20rnd USP Magazine"
	or string_id == "bm_wp_pis_usp_m_extended_desc" and "##10% slower## reload speeds."
	--Expert
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_usp_b_expert" and "USP Expert Slide"
	--Match
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_usp_b_match" and "USP Match Slide"
	or string_id == "bm_wp_pis_usp_b_match_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	
	--[[GRENADE 22]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_g22c" and "Glock 22C"
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_g22c" and "Akimbo Glock 22Cs"
	...
	--Long Slide
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g22c_b_long" and "Glock 35 Compensated Slide"
	or string_id == "bm_wp_g22c_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	
	--[[GRENADE 17]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_glock_17" and "Glock 17"
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_g17" and "Akimbo Glock 17s"
	...
	--[[GRENADE 26]]
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_g26" and  "Glock 26"
	or DMCWO._data.reelnames == true and string_id == "bm_w_jowi" and  "Akimbo Glock 26s"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g26_body_salient" and  "Stipled Tan Frame"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g26_b_custom" and  "Brushed Metal Frame"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g26_m_custom" and  "G26 Stipled Tan Magazine"
	or string_id == "bm_wp_g26_m_custom_desc" and  "##15% faster## reload speeds."
	
	--[[FAWHTY FAHVE]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_colt_1911" and "Springfield Operator 1911" 
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_1911" and "Akimbo Springfield Operator 1911s" 
	...
	--Aggressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_co_2" and "TCII Compensator" --Not 100% but seems to be based off of it
	--Punisher
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_co_1" and "Clark Heavy Pinmaster" --Not 100% but seems to be based off of it
	--Ergo Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_g_ergo" and "Pachmayr 1911 Grip" 
	or string_id == "bm_wp_1911_g_ergo_desc" and "##5% faster## ADS speeds." 
	--Wood Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_g_bling" and "Walnut Grips." 
	--Engraved Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_g_engraved" and "Custom Engraved 1911 Grips" 
	--Long
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_b_long" and "Compensated Long Barrel & Slide" 
	or string_id == "bm_wp_1911_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	--Vented
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_b_vented" and "Compensated Two-Tone Slide"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_1911_m_extended" and "10rnd 1911 Magazine"
	or string_id == "bm_wp_1911_m_extended_desc" and "##2.5% slower## reload speeds."
	
	--[[BARDODA]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_b92fs" and "Beretta 92FS"
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_b92fs" and "Akimbo Beretta 92FSs"	
	...
	--Professional
	or DMCWO._data.reelnames == true and string_id == "bm_wp_beretta_co_co1" and "SGS Compensator" --Original name was a reference to the movie "The Professional"
	--Competitor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_beretta_co_co2" and "Competition Compensator" --Seems to actually be based off of the Shorty USA Beretta 92 Spring Gun, unsurprising considering some of the guns models were based off of airsoft counterparts
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_beretta_m_extended" and "30rnd 92FS Magazine"
	or string_id == "bm_wp_beretta_m_extended_desc" and "##5% slower## reload speeds."
	--Elite Slide
	or DMCWO._data.reelnames == true and string_id == "bm_wp_beretta_sl_brigadier" and "Brigadier Elite Slide"
	--Ergo
	or DMCWO._data.reelnames == true and string_id == "bm_wp_beretta_g_ergo" and "Walnut Ergo Grips"
	--Engraved
	or DMCWO._data.reelnames == true and string_id == "bm_wp_beretta_g_engraved" and "Custom Engraved 92FS Grips"
	
	
	--[[HUEHUEHUEHUE]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_raging_bull" and "Taurus Raging Bull"
	or string_id == "bm_w_raging_bull_desc" and "A Brazilian revolver chambered in .44 Magnum.\nCan pierce enemies, walls and shields\nBenefits from pistol skills."
	--Mount
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_rage_extra" and "Raging Bull Scope Mount"
	--Aggressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_rage_b_comp1" and "S&W V-Compensator"
	--Pocket
	or DMCWO._data.reelnames == true and string_id == "bm_wp_rage_b_short" and "Snub Nose Barrel"
	or string_id == "bm_wp_rage_b_short_desc" and "##25% shorter## overall range.\n##5% faster## ADS speeds." 
	--Ventilated
	or DMCWO._data.reelnames == true and string_id == "bm_wp_rage_b_comp2" and "S&W Muzzle Compensator"
	or string_id == "bm_wp_rage_b_comp2_desc" and "Vents muzzle flash to the sides."
	--Overcompensating
	or DMCWO._data.reelnames == true and string_id == "bm_wp_rage_b_long" and "Long Barrel"
	or string_id == "bm_wp_rage_b_long_desc" and "##10% longer## overall range.\n##5% slower## ADS speeds." 
	
	--[[HUEHUEHUEHUE BUT IT'S A SHOTGUN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_judge" and "Taurus 4510PLYFS"
	or DMCWO._data.judge_pistol == true and string_id == "bm_w_judge_desc" and "Also known as \"The Judge\".\nA Brazilian revolver loaded with .410 bore shells.\nCan be loaded with special ammo types.\nBenefits from pistol skills."
	or string_id == "bm_w_judge_desc" and "Also known as \"The Judge\".\nA Brazilian revolver loaded with .410 bore shells.\nCan be loaded with special ammo types.\nBenefits from shotgun skills."
	
	--[[GRENADE 18]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_glock_18c" and "Glock 18C"
	...
	--Velocity
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g18c_co_comp_2" and "SJC Compensator 9mm"
	
	--[[DEAGLE]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_deagle" and "IMI Desert Eagle Mark XIX" --"IS THAT A M16?"
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_deagle" and "Akimbo IMI Desert Eagles"
	or string_id == "bm_w_deagle_desc" and "An Israeli-American handgun chambered in .44 Magnum.\nCan pierce enemies, walls and shields.\n\n\"I won't rely on anyone anymore!\""
	or string_id == "bm_w_x_deagle_desc" and "A pair of Israeli-American handguns chambered in .44 Magnum.\nCan pierce enemies, walls and shields.\n\nCan switch between single-fire, dual-fire and auto-fire.\n\nWhile auto-firing, ROF is lowered by 50% and the effects of Gun Nut Aced are not accounted for."
	--Mount
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_deagle_extra" and "Desert Eagle Scope Mount"
	--La Femme
	or DMCWO._data.reelnames == true and string_id == "bm_wp_deagle_co_short" and "Desert Eagle Muzzle Brake" --Original name was a reference to a 1990s film only for the gun's appearance in it, otherwise this is based on a real attachment
	--Overkill
	or DMCWO._data.reelnames == true and string_id == "bm_wp_deagle_co_long" and "Custom Barrel Weight" --Attachment is a reference to the Boondock Saints
	or string_id == "bm_wp_deagle_co_long_desc" and "##5% slower## ADS speeds." 
	--Ergo
	or DMCWO._data.reelnames == true and string_id == "bm_wp_deagle_g_ergo" and "Pachmayr Desert Eagle Grip" --These don't exist but it's the same model from the 1911 but enlarged so w/e
	or string_id == "bm_wp_deagle_g_ergo_desc" and "##5% faster## ADS speeds." 
	--Bling
	or DMCWO._data.reelnames == true and string_id == "bm_wp_deagle_g_bling" and "Desert Eagle Pearl Grips"
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_deagle_m_extended" and "10rnd Desert Eagle Magazine" --Given the length of the mag and considering the .50 AE variant is single stack only, this is the only choice. Not that it matters that there's more ammo than what's stated *cough* 1911 12rnd Mag *cough*
	or string_id == "bm_wp_deagle_m_extended_desc" and "##5% slower## reload speeds." 
	--Long Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_deagle_b_long" and "10\" Long Barrel"
	or string_id == "bm_wp_deagle_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	
	
	--[[JAMES BOND]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_ppk" and "Walther PPK"
	or string_id == "bm_w_ppk_desc" and "A German handgun chambered in .32 ACP.\nCan pierce thin walls."
	--Laser Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_ppk_g_laser" and "Crimson Trace Laser Grip"
	--Long Side
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_ppk_b_long" and "PPKS Slide"
	
	--[[40 SW IS A SHIT ROUND]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_p226" and "Sig Sauer P226R"
	...
	--Velocity .40
	or DMCWO._data.reelnames == true and string_id == "bm_wp_p226_co_comp_2" and "SJC Compensator .40" --Technically only for the G17 but "Overkill logic" so yeah
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_p226_m_extended" and "22rnd P226 Magazine" --Not too sure if this exists, just basing it off of the fact the "22" is plastered all over the damn thing
	or string_id == "bm_wp_p226_m_extended_desc" and "##10% slower## reload speeds."
	--Two-Tone
	or DMCWO._data.reelnames == true and string_id == "bm_wp_p226_b_equinox" and "Equinox Duo-Tone Slide"
	--Long Slide
	or DMCWO._data.reelnames == true and string_id == "bm_wp_p226_b_long" and "Brushed Long Slide"
	or string_id == "bm_wp_p226_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	
	--[[LEO]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_hs2000" and "Springfield Armory XD(M)-40" --Fuck the texture labels, it's a XD(M)
	or string_id == "bm_w_hs2000_desc" and "A Croatian-American handgun chambered in .40 S&W.\nCan pierce walls."
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_hs2000_m_extended" and "22rnd XD(M)-40 Magazine"
	or string_id == "bm_wp_hs2000_m_extended_desc" and "##5% slower## reload speeds."
	--Custom Slide
	or DMCWO._data.reelnames == true and string_id == "bm_wp_hs2000_sl_custom" and "Compensated Slide"
	or string_id == "bm_wp_hs2000_sl_custom_desc" and "##5% faster## ADS speeds." 
	--Long Slide
	or DMCWO._data.reelnames == true and string_id == "bm_wp_hs2000_sl_long" and "Custom Slide"
	
	--[[RED 9]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_c96" and "Mauser C96"
	or string_id == "bm_w_c96_desc" and "A German handgun chambered in 7.63x25mm that can be converted to full-auto.\nCan pierce enemies and walls."
	--Long Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_c96_b_long" and "Carbine Barrel"
	or string_id == "bm_wp_c96_b_long_desc" and "##20% longer## overall range.\n##10% slower## ADS speeds."
	--Han Solo
	or DMCWO._data.reelnames == true and string_id == "bm_wp_c96_nozzle" and "DL-44 Muzzle"
	or string_id == "bm_wp_c96_nozzle_desc" and "Fire \"special\" rounds.\n##Can only penetrate body armor.##\nROF ##lowered## to ##250 RPM.##"
	--Scope
	or DMCWO._data.reelnames == true and string_id == "bm_wp_c96_sight" and "Schmidt & Bender 1-8x24 PM Short Dot"
	or string_id == "bm_wp_c96_sight_desc" and "High power scope.\n##40% slower## ADS speeds."
	--20rnd Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_c96_m_extended" and "20rnd C96 Magazine"

	--[[EVENFASTERRUNONSENTENCES]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_cobray" and "Cobray M11/9"
	or string_id == "bm_w_cobray_desc" and "An American machine pistol chambered in 9x19mm.\nCan pierce thin walls.\nBenefits from SMG skills.\n\nCan switch between full-auto and semi-auto."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_cobray_ns_barrelext" and "MAC Barrel Extension"
	or string_id == "bm_wp_cobray_ns_barrelext_desc" and "##10% slower## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_cobray_ns_silencer" and "SIONICS Suppressor"	
	or string_id == "bm_wp_cobray_ns_silencer_desc" and "A ##specialized## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n10% shorter## overall range.\n##10% slower## ADS speeds."	
	
	--[[RUNONSENTENCES]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_mac10" and "Ingram M10"
	or string_id == "bm_w_mac10_desc" and "An American machine pistol chambered in .45 ACP.\nCan pierce enemies and walls\nBenefits from SMG skills.\n\nCan switch between full-auto and semi-auto."
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mac10_m_extended" and "30rnd M10 Magazine"
	or string_id == "bm_wp_mac10_m_extended_desc" and "##5% slower## reload speeds."
	--Railed Handguard
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mac10_body_ris" and "MAC Rail System" --I'm getting nothing but airsoft results so generic name
	or string_id == "bm_wp_mac10_body_ris_desc" and "##5% slower## ADS speeds."
	--Skeletal Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mac10_s_skel" and "Low Mount Skeleton Stock"	
	
	--[[THOMPSON SENSEI]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m1928" and "Auto-Ordnance M1928"
	or string_id == "bm_w_m1928_desc" and "An American sub-machine gun chambered in .45 ACP.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	--Short Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m1928_b_short" and "Short Barrel"	
	...
	--Dis. Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m1928_fg_discrete" and "Synthetic Foregrip"	--for once it's actually a foregrip
	or string_id == "bm_wp_m1928_fg_discrete_desc" and "##5% faster## ADS speeds." 	--for once it's actually a foregrip
	--Dis. Pistol Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m1928_g_discrete" and "Synthetic Pistol Grip"	
	or string_id == "bm_wp_m1928_g_discrete_desc" and "##5% faster## ADS speeds." 	
	--Dis. Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m1928_s_discrete" and "Synthetic Stock"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_w_mp5" and "Heckler & Koch MP5A4" --"Empi"
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_mp5" and "Akimbo MP5A4s" --"Empi"
	...
	--Sehr Kurze
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp5_fg_m5k" and "MP5k Tri-Rail Kit"
	or string_id == "bm_wp_mp5_fg_m5k_desc" and "##15% shorter## overall range.\n##5% faster## ADS speeds.\nROF ##raised## to ##900 RPM.##"
	--Polizei Tactical
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp5_fg_mp5a5" and "MP5 Railed Handguard"
	--Ninja
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp5_fg_mp5sd" and "MP5SD Kit"
	or string_id == "bm_wp_mp5_fg_mp5sd_desc" and "##Internally suppressed## barrel.\nReduces the weapon's sound radius to ##2 meters.##\nROF ##lowered## to ##700 RPM.##"
	--Adjustable
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp5_s_adjust" and "Retractable Stock"
	--Bare Essentials
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp5_s_ring" and "No Stock" --"No Pantsu"
	--MP5 Drum
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp5_m_drum" and "110rnd GSG-5 .22lr Drum"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_w_mp9" and "Brugger & Thomet TP9SF"
	or string_id == "bm_w_mp9_desc" and "A Swiss-made machine pistol chambered in 9x19mm.\nBenefits from SMG skills.\n\nCan switch between full-auto and semi-auto."
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp9_m_extended" and "30rnd MP9 Magazine"
	or string_id == "bm_wp_mp9_m_extended_desc" and "##5% slower## reload speeds."
	--Skeletal Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp9_s_skel" and "Steyr TMP Fixed Stock"
	
	--[[IT STINGS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_scorpion" and "CZ Skorpion vz. 61"
	or string_id == "bm_w_scorpion_desc" and "A Czechoslovakian sub-machine gun chambered in .32 ACP.\nCan pierce thin walls.\n\nCan switch between full-auto and semi-auto."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_scorpion_m_extended" and "Dual Magazines"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_scorpion_b_suppressed" and "Skorpion Suppressor"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_w_uzi" and "IMI Uzi"
	or string_id == "bm_w_uzi_desc" and "An Israeli sub-machine gun chambered in 9x19mm.\nCan pierce thin walls.\n\nCan switch between full-auto and semi-auto."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_uzi_s_solid" and "Wooden Stock"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_uzi_fg_rail" and "FAB Defense Uzi Tri-Rail System"
	or string_id == "bm_wp_uzi_fg_rail_desc" and "##5% faster## ADS speeds." 
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_uzi_b_suppressed" and "IMI Two-Stage Suppressor" --It's IMI made but it was never imported. No idea what the model name is.
	or string_id == "bm_wp_uzi_b_suppressed_desc" and "A ##specialized## suppressor for the Uzi.\nReduces the weapon's sound radius to ##2 meters.\n10% shorter## overall range.\n##7.5% slower## ADS speeds."
	
	--[[B-BAKA]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_baka" and "IMI Micro Uzi"
	...
	--[[S-COOL SHOOTINGS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_tec9" and "Intratec TEC-9"
	or string_id == "bm_w_tec9_desc" and "A Swedish-American handgun chambered in 9x19mm that can be converted to full-auto.\nCan pierce thin walls."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_tec9_b_standard" and "AB-10 Barrel"
	or string_id == "bm_wp_tec9_b_standard_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds." 
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_tec9_ns_ext" and "TEC-9 Pseudo Barrel Extension"
	or string_id == "bm_wp_tec9_ns_ext_desc" and "##5% slower## ADS speeds."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_tec9_s_unfolded" and "Interdynamic MP-9 Wire Stock"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_tec9_m_extended" and "50rnd TEC-9 Magazine"
	or string_id == "bm_wp_tec9_m_extended_desc" and "##10% slower## reload speeds."
	
	--[[I PLAE SAINTS ROW]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_sr2" and "TsNIITochMash SR-2M \"Veresk\""
	or string_id == "bm_w_sr2_desc" and "A Russian PDW chambered in 9x21mm.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto."
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_sr2" and "Akimbo SR-2Ms"
	...
	--[[NOT A STEN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_sterling" and "Sterling L2A1"
	or string_id == "bm_w_sterling_desc" and "A British sub-machine gun chambered in 9x19mm.\nCan pierce thin walls.\n\nCan switch between full-auto and semi-auto."
	--Supp. Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sterling_b_suppressed" and "L34A1 Barrel"
	or string_id == "bm_wp_sterling_b_suppressed_desc" and "##Internally suppressed## barrel.\nReduces the weapon's sound radius to ##2 meters.\n10% slower## ADS speeds."
	--Heat Sink Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sterling_b_e11" and "BlasTech E-11 Barrel"
	...
	--10rnd Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sterling_m_short" and "10rnd L2A1 Magazine"
	or string_id == "bm_wp_sterling_m_short_desc" and "##20% faster## reload speeds."
	--34rnd Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sterling_m_long" and "34rnd L2A1 Magazine"
	or string_id == "bm_wp_sterling_m_long_desc" and "##10% slower## reload speeds."

	--[[BABBY AR]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_olympic" and "Olympic Arms K23B Tactical"
	or string_id == "bm_w_olympic_desc" and "An American carbine chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto.\nBenefits from rifle skills."
	
	--Railed Handguard
	or DMCWO._data.reelnames == true and string_id == "bm_wp_olympic_fg_railed" and "KAC Free Float Handguard" --a super short version at that, shares the delta ring so I'm assuming this is what it's based off of
	--Shorter Than Short
	or DMCWO._data.reelnames == true and string_id == "bm_wp_olympic_s_short" and "Buffer Tube Stock" 
	or string_id == "bm_wp_m4_uupg_b_medium_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	
	--[[BABBY SLAVSHIT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_akmsu" and "Soviet Union AKMSU"
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_akmsu" and "Akimbo AKMSUs"
	...
	--Moscow Special
	or DMCWO._data.reelnames == true and string_id == "bm_wp_akmsu_fg_rail" and "Samson K-Rail" --Seems to be loosely based off of the Samson K-Rail, it's the only thing that looked remotely like this
	or string_id == "bm_wp_akmsu_fg_rail_desc" and "##5% slower## ADS speeds."
	
	--[[OVERPRICED 22LR]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_p90" and "FN P90 TR"
	...
	--Long Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_p90_b_long" and "PS90 Barrel"
	or string_id == "bm_wp_p90_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	
	--[[LOL SWEDS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m45" and "Carl Gustaf Kpist M/45"
	...
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_smg_m45_m_extended" and "50rnd M/45 Magazine"
	or string_id == "bm_wp_smg_m45_m_extended_desc" and "##10% slower## reload speeds." 
	
	--[[YOU SUCK AND WE HATE YOU]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_mp7" and "Heckler & Koch MP7A2"
	or string_id == "bm_w_mp7_desc" and "A German personal defence weapon chambered in 4.6x30mm.\nCan pierce enemies, walls and shields.\n\nCan switch between full-auto and semi-auto."
	--B&T Suppressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp7_b_suppressed" and "B&T MP7 Rotex-II Suppressor"	
	or string_id == "bm_wp_mp7_b_suppressed_desc" and "A ##specialized## suppressor for the MP7.\nReduces the weapon's sound radius to ##2 meters.\n10% shorter## overall range.\n##7.5% slower## ADS speeds."	
	--Extended Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp7_m_extended" and "MP7 40rnd Magazine"
	or string_id == "bm_wp_mp7_m_extended_desc" and "##5% slower## reload speeds."
	--Extended Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp7_s_long" and "Extended Stock"
	
	--[[DEMOMAN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_gre_m79" and "Springfield Armory M79 Grenade Launcher"
	...
	--[[NADE SPAM]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m32" and "Milkor Grenade Launcher"
	or string_id == "bm_w_m32_desc" and "A South-African cylinder-fed grenade launcher loaded with 40mm grenades.\nCan fire incendiary rounds.\nDamage boosts from skills do not affect this weapon."
	
	--[[HONG MEI LING]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_china" and "\"China Lake\" Grenade Launcher"
	or string_id == "bm_w_china_desc" and "An American pump-action grenade launcher loaded with 40mm grenades.\nCan fire incendiary rounds.\nDamage boosts from skills do not affect this weapon."
	
	--[[REVOLVER OCELOT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_peacemaker" and "Colt Single Action Army" --"Revolver Ocelot"
	...
	--Long
	or DMCWO._data.reelnames == true and string_id == "bm_wp_peacemaker_barrel_long" and "12\" Barrel"
	or string_id == "bm_wp_peacemaker_barrel_long_desc" and "##20% longer## overall range.\n##5% slower## ADS speeds."
	--Short
	or DMCWO._data.reelnames == true and string_id == "bm_wp_peacemaker_barrel_short" and "5.5\" Barrel"
	or string_id == "bm_wp_peacemaker_barrel_short_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds." 
	--Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_peacemaker_handle_bling" and "Engraved SAA Grips"
	--Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_peacemaker_rifle_stock" and "Skeletal Stock"
		
	--[[Winchester]]--
	or DMCWO._data.reelnames == true and string_id == "bm_w_winchester1874" and "Winchester Model 1873"
	...
	--Long
	or DMCWO._data.reelnames == true and string_id == "bm_wp_winchester_b_long" and "Long Barrel"
	or string_id == "bm_wp_winchester_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	--Supp
	or DMCWO._data.reelnames == true and string_id == "bm_wp_winchester_b_suppressed" and "Suppressor"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_w_mateba" and "Mateba 2006M"
	...
	--Long
	or DMCWO._data.reelnames == true and string_id == "bm_wp_2006m_b_long" and "8\" Barrel"
	or string_id == "bm_wp_2006m_b_long_desc" and "##10% longer## overall range.\n##5% slower## ADS speeds."
	--Med
	or DMCWO._data.reelnames == true and string_id == "bm_wp_2006m_b_medium" and "5\" Barrel"
	--Short
	or DMCWO._data.reelnames == true and string_id == "bm_wp_2006m_b_short" and "2\" Barrel"
	or string_id == "bm_wp_2006m_b_short_desc" and "##15% shorter## overall range.\n##5% faster## ADS speeds." 
	
	--[[AS Val]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_asval" and "Tula Arms AS \"Val\""
	...
	--Short
	or DMCWO._data.reelnames == true and string_id == "bm_wp_asval_b_proto" and "Prototype Barrel"
	...
	--VSS
	or DMCWO._data.reelnames == true and string_id == "bm_wp_asval_s_solid" and "VSS Kit"
	or string_id == "bm_wp_asval_s_solid_desc" and "ROF ##lowered## to ##600 RPM.##"
		
	--[[SUB 2000]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_sub2000" and "Kel-Tec SUB-2000"
	or string_id == "bm_w_sub2000_desc" and "An American carbine chambered in 9x19mm.\nCan pierce thin walls.\nBenefits from pistol skills." 
	--Handguards
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sub2000_fg_gen2" and "Gen2 Handguard"
	or string_id == "bm_wp_sub2000_fg_gen2_desc" and "##5% faster## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sub2000_fg_railed" and "Red Lion R6 Handguard"
	or string_id == "bm_wp_sub2000_fg_railed_desc" and "##5% slower## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sub2000_fg_suppressed" and "Quad Rail Handguard w/Suppressor"
	or string_id == "bm_wp_sub2000_fg_suppressed_desc" and "A ##specialized## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n10% shorter## overall range.\n##10% slower## ADS speeds."
	
	--XXX Boner
	or DMCWO._data.reelnames == true and string_id == "bm_w_hunter" and "Avalanche CB1-50 Pistol Grip Crossbow"
	or string_id == "bm_w_hunter_desc" and "A handheld crossbow.\nNo police ammobox pickups.\nNon-exploded bolts can be retrieved and fired again.\nDamage boosts from skills do not affect this weapon."
	
	or DMCWO._data.reelnames == true and string_id == "bm_w_frankish" and "Basic Crossbow"
	or string_id == "bm_w_frankish_desc" and "A basic wooden crossbow.\nNo police ammobox pickups.\nNon-exploded bolts can be retrieved and fired again.\nDamage boosts from skills do not affect this weapon."
	
	or DMCWO._data.reelnames == true and string_id == "bm_w_arblast" and "Arbalest Crossbow"
	or string_id == "bm_w_arblast_desc" and "A heavy crossbow used during the 12th century.\nNo police ammobox pickups.\nNon-exploded bolts can be retrieved and fired again.\nDamage boosts from skills do not affect this weapon."
	
	--[[2000 crying babies]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_wa2000" and "Walther WA2000"
	or string_id == "bm_w_wa2000_desc" and "A German semi-automatic bullpup rifle chambered in .300 Winchester Magnum.\nCan pierce enemies, walls and shields."
	--Long
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wa2000_b_long" and "Long Barrel"
	or string_id == "bm_wp_wa2000_b_long_desc" and "##15% longer## overall range.\n##7.5% slower## ADS speeds."
	--Supp.
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wa2000_b_suppressed" and "Suppressor"
	or string_id == "bm_wp_wa2000_b_suppressed_desc" and "A ##large## suppressor.\n##10% shorter## overall range.\n##10% slower## ADS speeds."
	--Light
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wa2000_g_light" and "Lightweight Furniture"
	or string_id == "bm_wp_wa2000_g_light_desc" and "##5% faster## ADS speeds.\n##10% faster## movement."
	--Black
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wa2000_g_stealth" and "Black Furniture"
	--Walnut
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wa2000_g_walnut" and "Walnut Furniture"
	or string_id == "bm_wp_wa2000_g_walnut_desc" and "##5% slower## ADS speeds."
	
	--[[Vector]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_polymer" and "KRISS Vector SMG"
	or string_id == "bm_w_polymer_desc" and "A recoil mitigating American sub-machine gun chambered in .45 ACP.\nCan pierce enemies and walls.\n\nCan switch between full-auto, 2-rnd burst and semi-auto."
	--CRB
	or DMCWO._data.reelnames == true and string_id == "bm_wp_polymer_barrel_precision" and "CRB Barrel w/Shroud"
	or string_id == "bm_wp_polymer_barrel_precision_desc" and "##20% longer## overall range.\n##10% slower## ADS speeds."
	--Supp
	or DMCWO._data.reelnames == true and string_id == "bm_wp_polymer_ns_silencer" and "Defiance HPS 4GSK Suppressor"
	or string_id == "bm_wp_polymer_ns_silencer_desc" and "A ##specialized## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n10% shorter## overall range.\n##10% slower## ADS speeds."
	
	--[[JERRY CAN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_sparrow" and "IMI JERICHO 941 RPL"
	or string_id == "bm_w_sparrow_desc" and "An Israeli handgun based off the Czechoslovakian CZ-75, chambered in 9x19mm.\nCan pierce thin walls.\n\n\"Bang...\""
	or DMCWO._data.reelnames == true and string_id == "bm_wp_sparrow_body_941" and "IMI JERICHO 941 F Kit"
	...
	--[[Model 70]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_model70" and "Winchester Model 70"
	...
	--[[Model 37]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m37" and "Ithaca Model 37 Homeland Security"
	...
	--[[PL-14]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_pl14" and "Concern Kalashnikov PL-14 \"Lebedev\""
	or string_id == "bm_w_pl14_desc" and "A Russian prototype handgun chambered in 9x19mm.\nCan pierce thin walls."
	--Barrel Ext.
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pl14_m_extended" and "PL-14 Magazine Extension"
	or string_id == "bm_wp_pl14_m_extended_desc" and "##2.5% slower## reload speeds."
	--Barrel Ext.
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pl14_b_comp" and "Ported Compensator"
	or string_id == "bm_wp_pl14_b_comp_desc" and "Vents muzzle flash to the sides"

	--[[LOL DRUMS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_tecci" and "Heckler & Koch HK416-C"
	or string_id == "bm_w_tecci_desc" and "A German carbine chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto.\nBenefits from rifle skills."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_tecci_b_long" and "Long Barrel"
	or string_id == "bm_wp_tecci_b_long_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds." 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_tecci_ns_special" and "JPE Recoil Eliminator Muzzle Brake"
	or string_id == "bm_wp_tecci_ns_special_desc" and "Vents muzzle flash to the sides." 
	
	--[[Muh Range]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_boot" and "Winchester Model 1887"
	...
	--Body
	or DMCWO._data.reelnames == true and string_id == "bm_wp_boot_body_exotic" and "Case Hardened Reciever"
	
	--[[Not the same Bren]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_hajk" and "CZ 805 BREN"
	or string_id == "bm_w_hajk_desc" and "A Czechoslovakian assault rifle chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto, 2-rnd burst and semi-auto.\nBenefits from rifle skills."
	--Short Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_hajk_b_short" and "A2 Barrel"
	or string_id == "bm_wp_hajk_b_short_desc" and "##15% shorter## overall range.\n##5% faster## ADS speeds." 
	
	--[[WEAPON MODS]]
	--Ported
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ns_battle" and "Battlecomp 2.0 Compensator"
	--MP5 10mm Magazine
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp5_m_straight" and "30rnd MP5/10 10mm Magazine"
	or string_id == "bm_wp_mp5_m_straight_desc" and "10mm Auto conversion for the MP5.\n##10% longer## overall range.\n##5% slower## reload speeds."
	--AK5 CQB
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak5_b_short" and "Short Barrel" 
	or string_id == "bm_wp_ak5_b_short_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds." 
	--AUG Raptor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_aug_body_f90" and "Thales F90 Body Kit"
	or string_id == "bm_wp_aug_body_f90_desc" and "ROF ##raised## to ##850 RPM.##"
	--SALVO
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_sho_salvo_large" and "SilencerCo Salvo 12 Suppressor"
	or string_id == "bm_wp_upg_ns_sho_salvo_large_desc" and "A ##large## shotgun suppressor.\nReduces the weapon's sound radius to ##2 meters.\n30% shorter## overall range.\n##10% slower## ADS speeds."
	--MP9 Suppressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mp9_b_suppressed" and "B&T MP9 QD Suppressor"
	or string_id == "bm_wp_mp9_b_suppressed_desc" and "A ##specialized## suppressor for the MP9.\nReduces the weapon's sound radius to ##2 meters.\n10% shorter## overall range.\n##10% slower## ADS speeds."
	--BIG BOSS
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_pis_jungle" and "Boss Suppressor"
	or string_id == "bm_wp_upg_ns_pis_jungle_desc" and "A ##large## suppressor.\n##10% shorter## overall range.\nReduces the weapon's sound radius to ##2 meters.\n10% slower## ADS speeds."
	--Filter
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_filter" and "Oil Filter"
	or string_id == "bm_wp_upg_ns_ass_filter_desc" and "An ##improvised## suppressor.\n##10% shorter## overall range.\nReduces the weapon's sound radius to ##10 meters.\n10% slower## ADS speeds."
	--M14 Scope Mount
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_m14_scopemount" and "Sun Optics USA M14/M1A Scope Mount"
	--LED Combo
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_ass_utg" and "UTG P38 LED Laser Combo"
	--M3X
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_pis_m3x" and "Insight Technology M3X"
	--P90 Mall
	or string_id == "bm_wp_p90_b_ninja_desc" and "##Internally suppressed## barrel.\nReduces the weapon's sound radius to ##2 meters.\n##15% slower## ADS speeds."
	--P90 Civ
	or DMCWO._data.reelnames == true and string_id == "bm_wp_p90_b_civilian" and "Moerse Lekker Barrel Shroud"
	or string_id == "bm_wp_p90_b_civilian_desc" and "##15% longer## overall range.\n##10% slower## ADS speeds."
	
	
	
	--AK Crab Rail
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_fg_krebs" and "Krebs UFM Keymod System Handguard"
	or string_id == "bm_wp_upg_ak_fg_krebs_desc" and "##7.5% faster## ADS speeds."
	--AK Keymod Rail
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_fg_trax" and "Strike Industries TRAX Handguard"
	or string_id == "bm_wp_upg_ak_fg_trax_desc" and "##7.5% slower## ADS speeds."
	--AK Aluminum Grip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_g_rk3" and "ZenitCo PK-3 Pistol Grip"
	--AK Aluminum Foregrip
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_fg_zenit" and "ZenitCo Handguard"
	--Scope Mount
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_ak_scopemount" and "K-VAR KV-04S Optic Mount"
	--Low Drag Magazine
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_m_uspalm" and "30rnd US PALM AK30 Magazine"
	or string_id == "bm_wp_upg_ak_m_uspalm_desc" and "##5% faster## reload speeds."
	--PBS Suppressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_pbs1" and "PBS-1 Suppressor"
	or string_id == "bm_wp_upg_ns_ass_pbs1_desc" and "##10% shorter## overall range.\nReduces the weapon's sound radius to ##2 meters.\n20% slower## ADS speeds."
	--DMR Kit
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_ak_b_zastava" and "Zastava M76 Barrel"
	or string_id == "bm_wp_upg_ass_ak_b_zastava_desc" and "##Sniper class barrel.##\n##30% longer## overall range.\n##10% greater## minimum damage.\n##10% slower## ADS speeds."
	--Modern Barrel
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_b_ak105" and "AK-105 Barrel"
	or string_id == "bm_wp_upg_ak_b_ak105_desc" and "##10% shorter## overall range."
	
	--Exotique Receiver
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_upper_reciever_edge" and "VLTOR Upper Receiver"
	or string_id == "bm_wp_m4_upper_reciever_edge_desc" and "ROF ##raised## by ##2%.##"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_m4_upper_reciever_ballos" and "2A-Arm BALIOS Upper Receiver" --????
	or string_id == "bm_wp_upg_ass_m4_upper_reciever_ballos_desc" and "ROF ##lowered## by ##5%.##"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_m4_upper_reciever_core" and "CORE15 Upper Receiver"
	or string_id == "bm_wp_upg_ass_m4_upper_reciever_core_desc" and "ROF ##raised## by ##5%.##"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_m4_lower_reciever_core" and "CORE15 Lower Receiver"
	or string_id == "bm_wp_upg_ass_m4_lower_reciever_core_desc" and "##5% faster## reload speeds."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_m4_s_ubr" and "Magpul UBR Stock"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_m4_m_l5" and "30rnd Lancer Systems L5 AW Magazine"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_smg_olympic_fg_lr300" and "Short LR300 Handguard"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_m16_fg_stag" and "Stag Arms Model 8T Handguard"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_m4_fg_moe" and "Magpul MOE SL Handguard"
	or string_id == "bm_wp_upg_ass_m4_fg_moe_desc" and "##5% faster## ADS speeds." 
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_m4_fg_lvoa" and "War Sport LVOA Handguard"
	or string_id == "bm_wp_upg_ass_m4_fg_lvoa_desc" and "##5% slower## ADS speeds."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_m4_b_beowulf" and "Beowulf Barrel"
	...
	or string_id == "m249_para" and "Para Kit"
	or string_id == "m249_para_desc" and "ROF ##lowered## to ##725 RPM.##"
	
	or string_id == "hk21_brenner" and "Brenner Kit"
	or string_id == "hk21_brenner_desc" and "ROF ##lowered## to ##450 RPM.##"
	
	--Pistol Light
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_pis_tlr1" and "Streamlight TLR1"
	--Pistol Laser
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_pis_laser" and "Aim Sports LH002 Laser Sight" 
	--Pistol Laser
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_x400v" and "SureFire X400V-IRC"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_crimson" and "Crimson Trace CMR-201"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_g_laser" and "Crimson Trace Glock Laser Grip"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_pis_g_beavertail" and "Beavertail Grip Extension"
	
	--Assault Light
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_ass_smg_sho_surefire" and "SureFire Scout Light" 
	--Compact Laser
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_ass_laser" and "Offset Laser Mount & Sight"
	--Tactical Laser
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_ass_smg_sho_peqbox" and "Insight Technology AN/PEQ-5"
	--Military Laser 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fl_ass_peq15" and "Insight Technology AN/PEQ-15"

	--Shark Teeth
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_shot_shark" and "Tromix Shark Breaching Brake"
	--King's Crown
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_shot_ns_king" and "King Armory KA-1212 Breaching Brake"
	
	--Pistol Flash Hider
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_pis_ns_flash" and "CCF Titanium Flash Suppressor"
	or string_id == "bm_wp_upg_pis_ns_flash_desc" and "Hides muzzle flash"

	--Low Profile Suppressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_smg_small" and "GemTech HALO Suppressor" --not 100% but I can't find any other suppressor that is similar to this one's two-piece construction and the ability to wrap around an A2 style muzzle brake
	or string_id == "bm_wp_upg_ns_ass_smg_small_desc" and "A ##small## suppressor.\nReduces the weapon's sound radius to ##10 meters.\n20% shorter## overall range."
	--Medium Suppressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_smg_medium" and "Small Arms Industries M80 Suppressor" --Thanks Overkill for being vauge as fuck, I'm surprised I even found this
	or string_id == "bm_wp_upg_ns_ass_smg_medium_desc" and "A ##medium## suppressor.\nReduces the weapon's sound radius to ##6 meters.\n30% shorter## overall range.\n##5% slower## ADS speeds."
	--Bigger the Better **Don't know
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_smg_large" and "Large Suppressor"
	or string_id == "bm_wp_upg_ns_ass_smg_large_desc" and "A ##large## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n40% shorter## overall range.\n##7.5% slower## ADS speeds."
	
	--Size Doesn't Matter 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_pis_small" and "Thompson Machine Poseidon Suppressor"	
	or string_id == "bm_wp_upg_ns_pis_small_desc" and "A ##small## suppressor.\nReduces the weapon's sound radius to ##10 meters.\n20% shorter## overall range."	
	--Standard Issue
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_pis_medium" and "GemTech SFN Suppressor" --Close enough... it's sectioned similarly enough for me to just name it this
	or string_id == "bm_wp_upg_ns_pis_medium_desc" and "A ##medium## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	--Monolith 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_pis_large" and "SilencerCo Osprey Suppressor"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_medium_gem" and "GemTech Blackside Suppressor"
	or string_id == "bm_wp_upg_ns_medium_gem_desc" and "A ##medium## suppressor.\nReduces the weapon's sound radius to ##6 meters.\n30% shorter## overall range.\n##5% slower## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_large_kac" and "KAC MK.23 Suppressor"
	or string_id == "bm_wp_upg_ns_large_kac_desc" and "A ##large## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n40% shorter## overall range.\n##7.5% slower## ADS speeds."
	
	
	--Shotgun Suppressor
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_shot_thick" and "Shotgun Suppressor"
	or string_id == "bm_wp_upg_ns_shot_thick_desc" and "A ##medium## suppressor.\nReduces the weapon's sound radius to ##6 meters.\n20% shorter## overall range.\n##5% slower## ADS speeds."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_meatgrinder" and "Standoff Muzzle Device"
	
	--Stubby
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_smg_stubby" and "Stinger Flash Hider" --Based on the VFC Stinger's pseudo flash-hider
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_smg_tank" and "Tank Compensator"
	or string_id == "bm_wp_upg_ns_ass_smg_tank_desc" and "Vents muzzle flash to the sides"
	--Firebreather
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_ass_smg_firepig" and "Noveske KX3 Compensator"
	or string_id == "bm_wp_upg_ns_ass_smg_firepig_desc" and "Increases muzzle flash"
	
	--Competitors
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_ns_jprifles" and "JPE Bennie Cooley Muzzle Brake"
	--Funnel of Fun
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_ns_linear" and "KIES Blast Master Linear Compensator"
	or string_id == "bm_wp_upg_ass_ns_linear_desc" and "Increases muzzle flash"
	--Tactical
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ass_ns_surefire" and "SureFire MBK Muzzle Brake"
	
	--Muldon
	or DMCWO._data.reelnames == true and string_id == "bm_wp_r870_s_folding" and "R870 Top Folding Stock"
	or string_id == "bm_wp_r870_s_folding_desc" and ""
	
	--Standard
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_s_standard" and "Bushmaster LE Stock"
	or string_id == "bm_wp_m4_s_standard_desc" and ""
	--Tactical
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_s_pts" and "Magpul PTS Stock"
	or string_id == "bm_wp_m4_s_pts_desc" and ""
	--Folding
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_uupg_s_fold" and "LR300 Folding Stock"
	or string_id == "bm_wp_m4_uupg_s_fold_desc" and ""
	--Wide
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_m4_s_crane" and "NSWC Crane Stock"
	or string_id == "bm_wp_upg_m4_s_crane_desc" and ""
	--War-Torn
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_m4_s_mk46" and "NSWC Crane Stock w/Cheek Pad" --looking at it now, the rudimentary cheek pad is generally useless since you hold the gun right handed (so you make a cheekweld with the left side of the gun) and the pad is mostly on the right. GJ Overkill.
	or string_id == "bm_wp_upg_m4_s_mk46_desc" and ""
	
	--Folding Stock (underfolder)
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak_s_folding" and "Underfolding AK Stock"
	or string_id == "bm_wp_ak_s_folding_desc" and "Underfolding AK Stock"
	--Folding Stock (sidefolder)
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak_s_skfoldable" and "Sidefolding AK Stock"
	or string_id == "bm_wp_ak_s_skfoldable_desc" and "Sidefolding AK Stock"
	--Wooden Sniper Stock
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak_s_psl" and "PSL Thumbhole Stock"
	or string_id == "bm_wp_ak_s_psl_desc" and ""
	
	--Ergo (Glocks)
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g18c_g_ergo" and "Hogue Handall Grip Sleeve"
	or string_id == "bm_wp_g18c_g_ergo_desc" and "##5% faster## ADS speeds." 
	--Ergo
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_g_ergo" and "Command Arms UPG16 Pistol Grip"
	or string_id == "bm_wp_m4_g_ergo_desc" and "##5% faster## ADS speeds." 
	--Pro
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_g_sniper" and "PSG Style Pistol Grip" --there are a bunch of grips styled after the PSG-1's grip but the one in PD2 doesn't seem to take from any specific real-life model
	--Rubber
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_m4_g_hgrip" and "Hogue OverMolded AR Pistol Grip"
	--Straight
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_m4_g_mgrip" and "Magpul MOE-K Pistol Grip"
	
	--Rubber
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_g_hgrip" and "Hogue OverMolded AK Pistol Grip"
	--Plastic
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_g_pgrip" and "US PALM Enhanced Pistol Grip"
	or string_id == "bm_wp_upg_ak_g_pgrip_desc" and "##5% faster## ADS speeds." 
	
	--Wood Rail
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak_fg_combo2" and "Ultimak AK Optic Mount"
	--Tact. Russian
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak_fg_combo3" and "Ultimak AK Modular Rail Forend System"
	or string_id == "bm_wp_ak_fg_combo3_desc" and "##5% slower## ADS speeds."
	--Battleproven
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_fg_tapco" and "Tapco Intrafuse Handguard" --This is actually for the Saiga. lolOverkill
	--Lightweight
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_fg_midwest" and "Midwest Industries Quad Rail"
	or string_id == "bm_wp_upg_fg_midwest_desc" and "##5% faster## ADS speeds."
	
	--Slav. Dragon
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_b_draco" and "Draco Pistol Barrel"
	or string_id == "bm_wp_upg_ak_b_draco_desc" and "##10% shorter## overall range.\n##10% faster## ADS speeds."
	
	--Extended Mag (Glocks)
	or DMCWO._data.reelnames == true and string_id == "bm_wp_g18c_m_mag_33rnd" and "33/22rnd Glock Magazine (9mm/.40S&W)"	
	or string_id == "bm_wp_g18c_m_mag_33rnd_desc" and "##5% slower## reload speeds."	
	--Vintage Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_m_straight" and "20rnd STANAG Magazine" --Hesitant to call them this since they're so off-model and resemble the M4A1 mags used in MW3
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_m_straight_vanilla" and "20rnd STANAG Magazine"
	or string_id == "bm_wp_m4_m_straight_desc" and "##10% faster## reload speeds."
	--Milspec Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_uupg_m_std" and "30rnd STANAG Magazine"
	--Tactical Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_m_pmag" and "30rnd Magpul PMAG Magazine"
	or string_id == "bm_wp_m4_m_pmag_desc" and "##5% faster## reload speeds."
	--Expert Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_l85a2_m_emag" and "30rnd Magpul EMAG Magazine"
	or string_id == "bm_wp_l85a2_m_emag_desc" and "Carry an extra magazine.\n##12% slower## reload speeds."
	--CAR Quad
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_m4_m_quad" and "60rnd SureFire Magazine"
	or string_id == "bm_wp_upg_m4_m_quad_desc" and "##10% slower## reload speeds."
	--AK Quad
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ak_m_quad" and "60rnd Concern Kalashnikov Magazine"
	or string_id == "bm_wp_upg_ak_m_quad_desc" and "##10% slower## reload speeds."
	--Beta-C
	or DMCWO._data.reelnames == true and string_id == "bm_wp_m4_m_drum" and "100rnd Beta-C Dual Drum"
	or string_id == "bm_wp_m4_m_drum_desc" and "##20% slower## reload speeds."
	--AK Drum
	or DMCWO._data.reelnames == true and string_id == "bm_wp_ak_m_drum" and "75rnd AK Drum"
	or string_id == "bm_wp_ak_m_drum_desc" and "##15% slower## reload speeds."
	
	--Pistol Red Dot
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_rmr" and "Trijicon RMR Red Dot Sight"
	...
	--Military Red Dot
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_aimpoint" and "Aimpoint PRO Red Dot Sight"
	or string_id == "bm_wp_upg_o_aimpoint_desc" and "Encased red dot sight."
	--Holographic
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_eotech" and "EOTech 553 Holographic Sight"
	or string_id == "bm_wp_upg_o_eotech_desc" and "Low power holographic sight."
	--Professional
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_t1micro" and "Aimpoint Micro T-1 Red Dot Sight"
	or string_id == "bm_wp_upg_o_t1micro_desc" and "Low power red dot sight."
	--Surgeon
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_docter" and "IRONDOT w/Docter Sight II Plus Red Dot Sight"
	or string_id == "bm_wp_upg_o_docter_desc" and "Low power red dot sight."
	--ACOUGH
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_acog" and "Trijicon ACOG Scope"
	or string_id == "bm_wp_upg_o_acog_desc" and "Medium range scope.\n##5% slower## ADS."
	--Milspec
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_specter" and "ELCAN Specter DR 1-4x Scope"
	or string_id == "bm_wp_upg_o_specter_desc" and "Medium range scope.\n##5% slower## ADS."
	--See More
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_cmore" and "C-More Railway Red Dot Sight"
	or string_id == "bm_wp_upg_o_cmore_desc" and "Low power red dot sight."
	--Combat
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_cs" and "Aimpoint CS Red Dot Sight"
	or string_id == "bm_wp_upg_o_cs_desc" and "Encased red dot sight."
	--Compact Holo
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_eotech_xps" and "EOTech EXPS3 Holographic Sight"
	or string_id == "bm_wp_upg_o_eotech_xps_desc" and "Low power holographic sight."
	--Speculator
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_reflex" and "Sightmark Sureshot Red Dot Sight" --super generic so I just went with what COD4 based it off of
	or string_id == "bm_wp_upg_o_reflex_desc" and "Low power red dot sight."
	--Trigonom
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_rx01" and "Trijicon RX01 Red Dot Sight"
	or string_id == "bm_wp_upg_o_rx01_desc" and "Low power red dot sight."
	--Solar
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_rx30" and "Trijicon RX30 Red Dot Sight"	
	or string_id == "bm_wp_upg_o_rx30_desc" and "Low power red dot sight."	
	--Theia
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_leupold" and "Leupold Mark 4 LR/T M1 Illum. Ret. w/BORS"
	or string_id == "bm_wp_upg_o_leupold_desc" and "Ballistic scope that ##auto-marks## enemies ##in stealth## or ##specials.##\n##10% slower## ADS."
	--45 irons
	or DMCWO._data.reelnames == true and string_id == "bm_wpn_fps_upg_o_45iron" and "XS Sights Angled Sights"
	--Flip-Up (KSG sights)
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_mbus_rear" and "Magpul MBUS Back-up Sights"
	or string_id == "bm_wp_upg_o_mbus_rear_desc" and "Flip-up sights."
	or DMCWO._data.reelnames == true and string_id == "dd_rear" and "Daniel Defense Fixed Sight Combo"
	or string_id == "dd_rear_desc" and "Fixed sights"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_mosin_iron_sight" and "Iron Sights"
	or string_id == "bm_wp_mosin_iron_sight_desc" and "Remove the scope and use iron sights."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_model_70_iron_sight" and "Iron Sights"
	or string_id == "bm_wp_model_70_iron_sight_desc" and "Remove the scope and use iron sights."
	
	--[[FOREGRIPS]]
	--VFG
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_vg_ass_smg_verticalgrip" and "Knights Armament Co. VFG"
	or string_id == "bm_wp_upg_vg_ass_smg_verticalgrip_desc" and "##20% less## recoil recovery."
	--STUBBY
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_vg_ass_smg_stubby" and "Tango Down QD Stubby VFG"
	or string_id == "bm_wp_upg_vg_ass_smg_stubby_desc" and "##10% less## recoil recovery."
	--AFG
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_vg_ass_smg_afg" and "Magpul AFG 2"
	...
	--Dragons Breath
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_a_dragons_breath" and "Dragon's Breath Rounds"
	...
	or string_id == "bm_wp_upg_a_dragons_breath_spas" and "Pellets capable of ##setting targets on fire.##\nFire ##8 pellets.##\n##50% chance## to set targets aflame within ##30m.##\nSemi-automatic ROF ##lowered## by ##20%.##"
	--AP Slug
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_a_slug" and "Armor Piercing SABOT Slugs"
	...
	--000 Buck
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_a_custom" and "000 Buck"
	...
	--Flechette
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_a_piercing" and "Flechette Rounds"
	...
	--HE
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_a_explosive" and "Fragmentation Rounds"
	...
	or string_id == "bullet_ap_desc_ak12" and "##Pierce shields in max damage range.\n+5%## damage through shields with the 7.62 kit.\n##No critical hits.\n+20%## damage to Dozer armor, MFR heads, Gensec and the Phalanx.\n##-40%## damage to the body of other units."
	...
	--Deagle Corbon
	or string_id == "rowland" and ".460 Rowland Conversion"
	or string_id == "rowland_desc" and "Rechambers this weapon in .460 Rowland.\n##15% more## penetration through walls.\n##15% longer## max damage range.\n##25% shorter## drop-off range"
	...
	--Deagle 50
	or string_id == "deagle_50" and ".50 AE Conversion"
	or string_id == "deagle_50_desc" and "Rechambers this weapon in .50 AE."
	--Deagle 357
	or string_id == "deagle_357" and ".357 Magnum Conversion"
	or string_id == "deagle_357_desc" and "Rechambers this weapon in .357 Magnum."
	...
	--Auto PL-14
	or string_id == "pl14_auto" and "Prototype Auto Kit"
	or string_id == "pl14_auto_desc" and "Allows for switching to ##full-auto.##\nROF ##raised## to ##1000 RPM.##\n##Disables the effects of Gun Nut Aced.##"
	
	--Scope
	or DMCWO._data.reelnames == true and string_id == "shortdot_normal" and "Schmidt & Bender 1-8x24 PM Short Dot"
	...
	or string_id == "damage_p1_desc" and "##10% less## total ammo."
	or string_id == "damage_p2_desc" and "##20% less## total ammo."
	
	or string_id == "bm_menu_bonus_total_ammo" and "Total Ammo Modifier"
	or string_id == "total_ammo_p1_desc" and "##10% more## total ammo.\n##5% slower## movement."
	or string_id == "total_ammo_p2_desc" and "##15% more## total ammo.\n##10% slower## movement."
	or string_id == "total_ammo_p3_desc" and "##20% more## total ammo.\n##15% slower## movement."
	...
	--URSA
	or DMCWO._data.reelnames == true and string_id == "bm_melee_kabar" and "USMC KA-BAR"
	...
	--Krieger
	or DMCWO._data.reelnames == true and string_id == "bm_melee_kampfmesser" and "KM 2000"
	...
	--Berger
	or DMCWO._data.reelnames == true and string_id == "bm_melee_gerber" and "Gerber DMF Folder"
	...
	--Lambo
	or DMCWO._data.reelnames == true and string_id == "bm_melee_rambo_desc" and "A survival knife with a heavy bowie blade. The length, sawtooth spine and centered tip works just as well in the wilderness as it does in close combat."
	
	--Tomahawk
	or DMCWO._data.reelnames == true and string_id == "bm_melee_tomahawk" and "Gerber Downrange Tomahawk"
	...
	--Becker Machete
	or DMCWO._data.reelnames == true and string_id == "bm_melee_becker" and "KA-BAR Becker Tac Tool"
	...
	--Baton
	or DMCWO._data.reelnames == true and string_id == "bm_melee_baton" and "ASP Friction Loc Baton"
	...
	--Shovel
	or DMCWO._data.reelnames == true and string_id == "bm_melee_shovel" and "K.L.A.S."
	...
	--EMONE
	or DMCWO._data.reelnames == true and string_id == "bm_melee_moneybundle" and "LODS OF EMONE"
	...
	--TWD Bat
	or DMCWO._data.reelnames == true and string_id == "bm_melee_baseballbat" and "\"Lucille\""
	...
	--Bayonet
	or DMCWO._data.reelnames == true and string_id == "bm_melee_bayonet" and "AKM Type II Bayonet"	
	...
	--Bullseye
	or DMCWO._data.reelnames == true and string_id == "bm_melee_bullseye" and "Smith & Wesson Bullseye Hatchet"
	...
	--X46
	or DMCWO._data.reelnames == true and string_id == "bm_melee_x46" and "Robson Knives X46 Utility Survival Knife"
	...
	--Gunther
	or DMCWO._data.reelnames == true and string_id == "bm_melee_dingdong" and "Gerber Ding Dong Breaching Tool"
	...
	--Cleaver girl
	or DMCWO._data.reelnames == true and string_id == "bm_melee_cleaver" and "Cleaver"
	...
	--Machete
	or DMCWO._data.reelnames == true and string_id == "bm_melee_machete" and "Machete"
	...
	--Briefcase
	or DMCWO._data.reelnames == true and string_id == "menu_l_global_value_hlm_game" and "This is a Hotline Miami Ownership item!"
	...
	--Tanto
	or DMCWO._data.reelnames == true and string_id == "bm_melee_kabar_tanto" and "KA-BAR Tanto"
	...
	--Chef
	or DMCWO._data.reelnames == true and string_id == "bm_melee_chef" and "Chef Knife"
	...
	--Trench Knife
	or DMCWO._data.reelnames == true and string_id == "bm_melee_fairbair" and "Fairbairn-Sykes Fighting Knife"
	...
	--Erica Hartmann
	or DMCWO._data.reelnames == true and string_id == "bm_melee_model24" and "Model 24 Stielhandgranate"
	...
	--Hammer time
	or DMCWO._data.reelnames == true and string_id == "bm_melee_hammer" and "Jacket's Hammer"
	...
	--Another Cleaver
	or DMCWO._data.reelnames == true and string_id == "bm_melee_meat_cleaver" and "Dragan's Cleaver"
	...
	--Tender lovin'
	or DMCWO._data.reelnames == true and string_id == "bm_melee_poker" and "Firewood Poker"
	...
	--Tender lovin'
	or DMCWO._data.reelnames == true and string_id == "bm_melee_tenderizer" and "Meat Tenderizer"
	...
	--Fork her
	or DMCWO._data.reelnames == true and string_id == "bm_melee_fork" and "BBQ Fork"
	...
	--Autism
	or DMCWO._data.reelnames == true and string_id == "bm_melee_mining_pick" and "Pickaxe"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_melee_bowie" and "Bowie Knife"
	...
	--MY BRAND
	or DMCWO._data.reelnames == true and string_id == "bm_melee_branding_iron" and "Branding Iron"
	...
	--WOLOLOLO
	or DMCWO._data.reelnames == true and string_id == "bm_melee_oldbaton" and "Nightstick"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_melee_detector" and "Garrett Handheld Metal Detector"
	...
	or DMCWO._data.reelnames == true and string_id == "bm_melee_taser" and "ZAP Stun Baton"
	...
	--Kunai
	or DMCWO._data.reelnames == true and string_id == "bm_melee_cqc" and "Kunai"
	--MMM Whatcha Sai~
	or DMCWO._data.reelnames == true and string_id == "bm_melee_twins" and "Sais"
	--Tekko-Kagi
	or DMCWO._data.reelnames == true and string_id == "bm_melee_tiger" and "Tekko-Kagi"
	...
	--Dive
	or DMCWO._data.reelnames == true and string_id == "bm_melee_pugio" and "Extrema Ratio Pugio SE"
	...
	--Gatorade
	or DMCWO._data.reelnames == true and string_id == "bm_melee_gator" and "Gerber Gator Machete Pro"
	...
	--BONK
	or DMCWO._data.reelnames == true and string_id == "bm_melee_scoutknife" and "Morakniv Classic Scout 39"
	...
	--Shears
	or DMCWO._data.reelnames == true and string_id == "bm_melee_shawn" and "Antique Sheep Shears"
	...
	--WREX
	or DMCWO._data.reelnames == true and string_id == "bm_melee_stick" and "Shepherd's Crook"
	...
	--NINE INCHES
	or DMCWO._data.reelnames == true and string_id == "bm_melee_nin" and "Paslode IM90i Nailgun"
	...
	--BUALS
	or DMCWO._data.reelnames == true and string_id == "bm_melee_ballistic" and "Ballistic Knives"
	...
	--flippity floop
	or DMCWO._data.reelnames == true and string_id == "bm_melee_wing" and "Benchmade Model 42 Balisong"
	...
	--Nade out
	or DMCWO._data.reelnames == true and string_id == "bm_grenade_frag" and "M67 Fragmentation Grenade"
	or DMCWO._data.reelnames == true and string_id == "bm_grenade_frag_com" and "M67 Fragmentation Grenade"
	--Throwing Axe
	or DMCWO._data.reelnames == true and string_id == "bm_wpn_prj_hur" and "Kit Rae Aircobra Throwing Axe"
	
	
	--[[CUSTOM WEAPONS]]
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_upg_o_m145" and "ELCAN Specter M145 Scope"
	or string_id == "bm_wp_wpn_fps_upg_o_m145_desc" and "Medium range scope.\n##5% slower## ADS."
	
	--CompM4
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_upg_o_compm4s" and "Aimpoint CompM4s Red Dot Sight"
	or string_id == "bm_wp_wpn_fps_upg_o_compm4s_desc" and "Encased red dot sight."
	
	--PK-AS
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_upg_o_pkas" and "BelOMO PK-AS Red Dot Sight"
	or string_id == "bm_wp_wpn_fps_upg_o_pkas_desc" and "Encased red dot sight."
	
	--Kobra
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_upg_o_kobra" and "Axion EKP-8-18 Red Dot Sight"
	or string_id == "bm_wp_wpn_fps_upg_o_kobra_desc" and "Low power red dot sight"
	
	--[[CHINASLAVSHIT]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_sks" and "Norinco SKS Model D"
	or string_id == "bm_w_sks_desc" and "A Chinese clone of the Russian SKS carbine, chambered in 7.62x39mm.\nCan pierce enemies and walls."
	or string_id == "bm_wp_wpn_fps_ass_sks_body_paratrooper_desc" and "##5% slower## movement.\n##5% slower## ADS speeds."
		
	--[[AH NU]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_toz34" and "Tula Arms TOZ-34"
	or string_id == "bm_w_toz34_desc" and "A Russian, over-under, break-action shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types.\n\nCan switch between single-trigger and dual-trigger."
	or string_id == "bm_wp_wpn_fps_shot_toz34_barrel_short_desc" and "##20% shorter## overall range.\n##5% faster## ADS speeds." 
		
	--[[SHATTER'S FURY]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_shatters_fury" and "Smith & Wesson Model 500"
	or string_id == "bm_w_shatters_fury_desc" and "An American revolver chambered in .500 S&W.\nCan pierce enemies, walls and shields\nBenefits from pistol skills.\n\nCustomized by Shatter himself, a gift from him to you."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_shatters_fury_g_ergo" and "Wood Ergo Grip"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_shatters_fury_b_comp1" and "6.5\" Model 629 Performance Center Barrel"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_shatters_fury_b_comp2" and "8.38\" Compensated Barrel"
	or string_id == "bm_wp_wpn_fps_pis_shatters_fury_b_comp2_desc" and "Vents muzzle flash to the sides.\n##10% longer## overall range.\n##5% slower## ADS speeds." 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_shatters_fury_b_long" and "10.5\" Performance Center Barrel"
	or string_id == "bm_wp_wpn_fps_pis_shatters_fury_b_long_desc" and "##15% longer## overall range.\n##10% slower## ADS speeds." 
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_shatters_fury_b_short" and "4\" Compensated Barrel"
	or string_id == "bm_wp_wpn_fps_pis_shatters_fury_b_short_desc" and "Vents muzzle flash to the sides.\n##25% shorter## overall range.\n##5% faster## ADS speeds."
	
	--[[Victor]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_sr3m" and "Tula Arms SR-3M \"Vikhr\""
	or string_id == "bm_w_sr3m_desc" and "A Russian assault rifle, chambered in 9x39mm.\nHas a sound radius of 2 meters.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	or string_id == "bm_wp_wpn_fps_ass_sr3m_supp_groza_desc" and ""
	
	--[[SR338]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_fd338" and  "F&D Defense FD338"
	or string_id == "bm_w_fd338_desc" and "An American AR-15 platform rifle chambered in .338 Lapua Magnum.\nCan pierce enemies, walls and shields."
	or string_id == "bm_wp_wpn_fps_ass_fd338_supp" and  "Custom Suppressor"
	or string_id == "bm_wp_wpn_fps_ass_fd338_supp_desc" and  "A ##large## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n40% shorter## overall range.\n##10% slower## ADS speeds."
	
	--[[GOASTS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_ak12" and "Concern Kalashnikov AK-12"
	or string_id == "bm_w_ak12_desc" and "A Russian assault rifle chambered in 5.45x39mm.\nCan pierce enemies and walls.\n\nCan switch between full-auto, 3-rnd burst and semi-auto."
	or string_id == "bm_wp_wpn_fps_ass_ak12u_barrel_desc" and "##10% shorter## overall range."
	or string_id == "bm_wp_wpn_fps_ass_rpk12_barrel_desc" and "##15% longer## overall range.\n##5% slower## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_ass_svk12_barrel" and "7.62 NATO Kit"
	or string_id == "bm_wp_wpn_fps_ass_svk12_barrel_desc" and "Rechambers this weapon in 7.62 NATO.\n##15% longer## overall range.\n##10% slower## ADS speeds."
	--AK-12 Quad Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_ass_ak12_mag_quad" and "60rnd Concern Kalashnikov Magazine"
	or string_id == "bm_wp_wpn_fps_ass_ak12_mag_quad_desc" and "##10% slower## reload speeds."
	
	--[[MW2]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_pp" and "KBP PP-2000" 
	or string_id == "bm_w_pp_desc" and "A Russian PDW chambered in 9x19mm.\nCan pierce thin walls.\n\nCan switch between full-auto and semi-auto."
	or string_id == "bm_wp_wpn_fps_smg_pp_b_large_desc" and "A ##large## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n40% shorter## overall range.\n##10% slower## ADS speeds."
	or string_id == "bm_wp_wpn_fps_smg_pp_b_small_desc" and "A ##small## suppressor.\nReduces the weapon's sound radius to ##10 meters.\n20% shorter## overall range."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_smg_pp_b_comp" and "SureFire MBK Muzzle Brake"
	
	--[[THE COD4 DAYS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_m40a5" and "USMC M40A5"
	or string_id == "bm_w_m40a5_desc" and "An American bolt-action rifle chambered in 7.62 NATO.\nCan pierce enemies, walls and shields."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_snp_m40a5_o_bf4flipup" and "Troy Industries Flip-up Battle Sights"
	or string_id == "bm_wp_wpn_fps_snp_m40a5_o_bf4flipup_desc" and "Remove the scope and use iron sights."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_snp_m40a5_o_scorpionevo" and "Skorpion EVO III Iron Sights"
	or string_id == "bm_wp_wpn_fps_snp_m40a5_o_scorpionevo_desc" and "Remove the scope and use iron sights."
	or string_id == "bm_wp_wpn_fps_snp_m40a5_omega_desc" and "A ##large## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n40% shorter## overall range.\n##10% slower## ADS speeds."
	
	--[[GROUCH]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_grach" and  "Izmekh MP-443 \"Grach\""
	or string_id == "bm_w_grach_desc" and "A Russian prototype handgun chambered in 9x19mm.\nCan pierce thin walls."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_grach_comp" and "Bushing Compensator"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_grach_sil" and "SureFire MINI-MONSTER Suppressor"
	or string_id == "bm_wp_wpn_fps_pis_grach_sil_desc" and "A ##medium## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	
	--[[CHINESE FIVE SEVEN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_qs" and "Norinco QSZ-92"
	or string_id == "bm_w_qs_desc" and "A Chinese handgun chambered in 5.8×21mm.\nCan pierce enemies and walls."
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_qs_las" and "SureFire X400V"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_qs_comp" and "Bushing Compensator"
	
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_qs_sil" and "SureFire MINI-MONSTER Suppressor"
	or string_id == "bm_wp_wpn_fps_pis_qs_sil_desc" and "A ##medium## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	
	--[[MY BAZOOKA]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_l115" and  "Accuracy International L115"
	or string_id == "bm_w_l115_desc" and "A British bolt-action rifle chambered in .338 Lapua Magnum.\nCan pierce enemies, walls and shields."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_upg_l115_body_green" and "Olive Drab Stock"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_upg_l115_irons" and "Troy Industries Flip-up Battle Sights"
	or string_id == "bm_wp_wpn_fps_upg_l115_irons_desc" and "Remove the scope and use iron sights."
	or string_id == "bm_wp_wpn_fps_upg_l115_supp" and "Custom Suppressor"
	or string_id == "bm_wp_wpn_fps_upg_l115_supp_desc" and  "A ##large## suppressor.\nReduces the weapon's sound radius to ##2 meters.\n40% shorter## overall range.\n##10% slower## ADS speeds."
	
	--[[SUPERNOVA]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_novas" and  "Benelli Nova"
	or string_id == "bm_w_novas_desc" and "An Italian, tube fed, pump-action shotgun loaded with 12-gauge shells.\nCan be loaded with special ammo types."
	
	--[[MW3 FLASHBACKS]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_fmg9" and  "Akimbo Magpul FMG-9s"
	or string_id == "bm_w_x_fmg9_desc" and "A pair of American sub-machine guns chambered in 9x19mm.\nCan pierce thin walls.\n\nCan switch between full-auto, semi-auto (dual-fired) and semi-auto (alternating)."
	
	--[[ACR]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_acw" and "Remington ACR"
	or string_id == "bm_w_acw_desc" and "A American assault rifle chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto and semi-auto."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_ass_acw_b_short" and "14.5\" Barrel"
	or string_id == "bm_wp_wpn_fps_ass_acw_b_short_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds."
	
	
	--[[MELTGUN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_g36k" and "Heckler & Koch G36K"
	or string_id == "bm_w_g36k_desc" and "A German carbine chambered in 5.56 NATO.\nCan pierce enemies and walls.\n\nCan switch between full-auto, 2-rnd burst and semi-auto.\nBenefits from rifle skills."
	--Compact
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_ass_g36k_fg_g36c" and "G36c Kit"
	or string_id == "bm_wp_wpn_fps_ass_g36k_fg_g36c_desc" and "##10% shorter## overall range.\n##5% faster## ADS speeds."
	--Full
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_ass_g36k_fg_g36" and "18.9\" Barrel"
	or string_id == "bm_wp_wpn_fps_ass_g36k_fg_g36_desc" and "##15% longer## overall range.\n##10% slower## ADS speeds.\n##5% slower## movement."
	--C-Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_ass_g36k_mag_cmag" and "100rnd Beta-C Dual Drum"
	or string_id == "bm_wp_wpn_fps_ass_g36k_mag_cmag_desc" and "##20% slower## reload speeds."
	
	--[[KF5]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_mpx" and "SIG Sauer MPX" 
	or DMCWO._data.reelnames == true and string_id == "bm_w_x_mpx" and "Akimbo SIG Sauer MPXs" 
	or string_id == "bm_w_mpx_desc" and "A Swiss sub-machine gun chambered in 9x19mm.\nCan pierce thin walls.\n\nCan switch between full-auto and semi-auto."
	or string_id == "bm_w_x_mpx_desc" and "A pair of Swiss sub-machine gun chambered in 9x19mm.\nCan pierce thin walls.\n\nCan switch between full-auto, semi-auto (dual-fired) and semi-auto (alternating)."
	--MPX-K
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_smg_x_mpx_fg_mpx_k" and "MPX-K Kit"
	or string_id == "bm_wp_wpn_fps_smg_mpx_fg_mpx_k_desc" and "##15% shorter## overall range.\n##5% faster## ADS speeds."
	--MPX-SD
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_smg_x_mpx_fg_mpx_sd" and "MPX-SD Kit"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_smg_mpx_fg_mpx_sd" and "MPX-SD Kit"
	or string_id == "bm_wp_wpn_fps_smg_mpx_fg_mpx_sd_desc" and "##Internally suppressed## barrel.\nReduces the weapon's sound radius to ##2 meters.##"
	--Mag
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_smg_x_mpx_mag_40" and ".40 S&W Conversion Kit"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_smg_mpx_mag_40" and ".40 S&W Conversion Kit"
	or string_id == "bm_wp_wpn_fps_smg_mpx_mag_40_desc" and ".40 S&W conversion for the MPX.\n##5% slower## reload speeds."
