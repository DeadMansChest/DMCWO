...
function BlackMarketTweakData:_init_melee_weapons()
	...
	--melee_baseballbat
	melee_anim = {
		'barbedwire','dingdong','baseballbat','alien_maul','freedom','fireaxe'
	}
	for i, melee_id in ipairs(melee_anim) do
	...
	--melee_blunt
	melee_anim = {
		'baton','oldbaton','detector','shovel','shillelagh','whiskey','iceaxe','morning','branding_iron'
	}
	for i, melee_id in ipairs(melee_anim) do
	...
	self.melee_weapons.fists.speed_mult = 1.7
	...
	--Open Palm Kata
	self.melee_weapons.fight.speed_mult = 2.25
	...
	self.melee_weapons.brass_knuckles.speed_mult = 1.5
	...
	self.melee_weapons.becker.stats.range = 190
	--Machete
	...
	self.melee_weapons.machete.stats.range = 210
	...
	self.melee_weapons.gator.stats.range = 230
	...
	self.melee_weapons.kabartanto.speed_mult = 1.05
	...
	self.melee_weapons.ballistic.stats.range = 150
	...
	self.melee_weapons.rambo.stats.range = 170
	...
	self.melee_weapons.bowie.stats.range = 185
	...
	self.melee_weapons.sandsteel.speed_mult = 1.15
	...
	if DMCWO.RULESOFNATURE then	
		self.melee_weapons.sandsteel.speed_mult = 2.3
		self.melee_weapons.sandsteel.stats.charge_time = 1.2
	...
	self.melee_weapons.great.stats.charge_time = 2.8
	self.melee_weapons.great.stats.min_damage = 10
	self.melee_weapons.great.stats.max_damage = 27.5
	...
	self.melee_weapons.beardy.stats.max_damage = 32
	self.melee_weapons.beardy.stats.min_damage_effect = .8
	...
	self.melee_weapons.morning.stats.min_damage_effect = 2.5
	self.melee_weapons.morning.stats.max_damage_effect = 3.5
	...
	self.melee_weapons.taser.speed_mult = 0.75
	self.melee_weapons.taser.stats.charge_time = 1.75
	...
	self.melee_weapons.taser.stats.range = 150
	--Zoose
	self.melee_weapons.zeus.type = "axe"
	self.melee_weapons.zeus.speed_mult = 1.2
	self.melee_weapons.zeus.stats.charge_time = 2.25
	self.melee_weapons.zeus.stats.min_damage = 1.0
	...
	self.melee_weapons.zeus.stats.range = 135
