...
local debug_damage = {'new_raging_bull','deagle','colt_1911','usp','p226','g22c','glock_17','glock_18c','b92fs','ppk','mac10','m45','mp9','new_mp5','mp7','p90','olympic','akmsu','akm','akm_gold','ak74','m16','amcar','new_m4','ak5','s552','g36','aug','saiga','r870','huntsman','benelli','ksg','serbu','striker','new_m14','scar','fal','hk21','rpk','m249','msr','r93','judge','famas','galil','g3','gre_m79','tec9','scorpion','uzi','x_deagle','x_1911','x_b92fs','jowi','g26','spas12','mg42','mosin','c96','sterling','m1928','l85a2'}
...
for i, wep_id in ipairs(ak_type_hold) do
	pivot_head_translation = Vector3(9, 24, -1)
	pivot_head_rotation = Rotation(0.0, 0.0, -1)
	tweak_data.player.stances[wep_id].standard.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	tweak_data.player.stances[wep_id].standard.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
	
	pivot_head_translation = Vector3(7, 22, 1)
...
for i, wep_id in ipairs(smg_type_wep) do
	...
	pivot_head_translation = Vector3(5, 38, -1)
	pivot_head_rotation = Rotation(0, 0, -2)
	tweak_data.player.stances[wep_id].crouched.shoulders.translation = pivot_head_translation - pivot_shoulder_translation:rotate_with(pivot_shoulder_rotation:inverse()):rotate_with(pivot_head_rotation)
	tweak_data.player.stances[wep_id].crouched.shoulders.rotation = pivot_head_rotation * pivot_shoulder_rotation:inverse()
end
...
--M79
tweak_data.weapon.gre_m79.fire_mode_data.fire_rate = 0.105 --sets the ROF just at the edge of the anti-cheat timer (1 per second)
...
--92FS (Bernetti 9)
tweak_data.weapon.b92fs.kick.standing = { 1.5, 2.5, -1.5, 1.5 }
...
tweak_data.weapon.b92fs.spread.steelsight = 1.45
...
--AKIMBO 92FS
tweak_data.weapon.x_b92fs.kick.standing = { 1.25, 2.25, -1.5, 1.5 }
...
tweak_data.weapon.x_b92fs.spread.standing = 3.5 * 2
tweak_data.weapon.x_b92fs.spread.crouching = 3 * 2
tweak_data.weapon.x_b92fs.spread.steelsight = 1.45 * 2
...
tweak_data.weapon.g26.damage_near = 500
tweak_data.weapon.g26.damage_far = 10000
...
tweak_data.weapon.g26.spread.moving_standing = tweak_data.weapon.g26.spread.standing * 1.2
tweak_data.weapon.g26.spread.moving_crouching = tweak_data.weapon.g26.spread.crouching * 1.2
tweak_data.weapon.g26.spread.moving_steelsight = tweak_data.weapon.g26.spread.steelsight * 1.2
...
tweak_data.weapon.jowi.spread.standing = 3.5 * 2
tweak_data.weapon.jowi.spread.crouching = 3 * 2
tweak_data.weapon.jowi.spread.steelsight = 1.65 * 2
tweak_data.weapon.jowi.spread.moving_standing = tweak_data.weapon.jowi.spread.standing * 1.2
tweak_data.weapon.jowi.spread.moving_crouching = tweak_data.weapon.jowi.spread.crouching * 1.2
tweak_data.weapon.jowi.spread.moving_steelsight = tweak_data.weapon.jowi.spread.steelsight * 1.2
...
tweak_data.weapon.hs2000.stats = {
		damage = 16,
		spread = 14,
		recoil = 11,
		spread_moving = 7,
...
--C96
tweak_data.weapon.c96.kick.standing = { 1.30, 3.0, -2.0, 2.0 }
...
pivot_shoulder_translation = Vector3(8.49051, 38.6474, -5.09399)
pivot_shoulder_rotation = Rotation(0.0999949, -0.687702, 0.630304)
pivot_head_translation = Vector3(7, 42, -1)
pivot_head_rotation = Rotation(0, 0, -1)
...
--[[PDWS]]	
--MP7
tweak_data.weapon.mp7.kick.standing = {1.6, -0.6, -1.0, 1.4}
...
pivot_head_translation = Vector3(9, 23, -2)
pivot_head_rotation = Rotation(0, 0, -1)
...
pivot_head_translation = Vector3(7, 21, 1)
pivot_head_rotation = Rotation(0, 0, -2)
...
--VHS
tweak_data.weapon.vhs.kick.standing = { -0.7, 1.4, -2.0, 2.0}
...
tweak_data.weapon.vhs.can_shoot_through_enemy = true
...
tweak_data.weapon.factory.parts.wpn_fps_ass_vhs_m.stats = {value = 1} --gets rid of the hidden stats the *default*, **non-removable** magazine applies.

tweak_data.weapon.vhs.stats = {
		damage = 18,
		spread = 16,
		recoil = 14,
		spread_moving = 8,
...
--M4A1 (CAR-4)
tweak_data.weapon.new_m4.kick.standing = { -0.65, 1.5, -1.75, 1.75}
...
tweak_data.weapon.m16.kick.standing = { -0.45, 1.8, -1.5, 1.5 }
...
--Gay for FNC (AUG)
tweak_data.weapon.aug.kick.standing = { -0.2, 1.9, -0.8, 0.8}
...
tweak_data.weapon.ak5.kick.standing = { -0.7, 1.25, -1.9, 1.9 }
...
--*Jam* (L85)
tweak_data.weapon.l85a2.kick.standing = { -0.8, 1.2, -0.9, 0.9}
...
tweak_data.weapon.l85a2.shake.fire_multiplier = -0.6
tweak_data.weapon.l85a2.shake.fire_steelsight_multiplier = -0.6
...
pivot_head_translation = Vector3(9, 33, -1)
pivot_head_rotation = Rotation(0, 0, -3)
...
pivot_head_translation = Vector3(7, 31, 1)
...
tweak_data.weapon.saiga.NR_CLIPS_MAX = 9
...
tweak_data.weapon.spas12.spread.moving_steelsight = tweak_data.weapon.spas12.spread.standing * 0.8
...
tweak_data.weapon.striker.kick.standing = {4.0, 3.0, -4.0, 4.0 } --{3.1, 2.25, -3.45, 3.45 }
...
tweak_data.weapon.scar.damage_min = 0.45
...
pivot_head_translation = Vector3(6, 24, 0)
pivot_head_rotation = Rotation(0.0, 0.0, -2)
...
tweak_data.weapon.fal.kick.standing = {-0.7, 1.1, -2.5, 2.5 }
...
tweak_data.weapon.fal.damage_min = 0.4
...
tweak_data.weapon.galil.kick.standing = {-1.60, 2.10, -1.80, 1.80 }
...
tweak_data.weapon.galil.damage_min = 0.4
...
tweak_data.weapon.new_m14.damage_min = 0.4
...
tweak_data.weapon.mg42.kick.steelsight = {1.70, -0.30, -1.1, 1.1 }
...
tweak_data.weapon.factory.wpn_fps_snp_m95.override.wpn_fps_snp_mosin_iron_sight = { adds = {"wpn_fps_ass_vhs_o_standard"}}
...
tweak_data.blackmarket.melee_weapons.brass_knuckles.stats.min_damage = 1.8
tweak_data.blackmarket.melee_weapons.brass_knuckles.stats.max_damage = 3.6
tweak_data.blackmarket.melee_weapons.brass_knuckles.stats.min_damage_effect = 4
tweak_data.blackmarket.melee_weapons.brass_knuckles.stats.max_damage_effect = 4
...
local enable_cstw = {'new_raging_bull','deagle','colt_1911','usp','p226','g22c','glock_17','glock_18c','b92fs','ppk','mac10','m45','mp9','new_mp5','mp7','p90','olympic','akmsu','akm','akm_gold','ak74','m16','amcar','new_m4','ak5','s552','g36','aug','new_m14','scar','fal','hk21','rpk','m249','msr','r93','m95','judge','famas','galil','g3','gre_m79','tec9','scorpion','uzi','x_deagle','x_1911','x_b92fs','jowi','g26','spas12','mg42','mosin','c96','sterling','m1928','l85a2','vhs','hs2000'}
...
for i, wep_id in ipairs(ammo_32) do
	tweak_data.weapon[ wep_id ].penetration_power = 0.2 --percent of how much your weapon's damage translates to penetration distance
...
local ammo_556 = {'olympic','m16','amcar','new_m4','ak5','s552','g36','aug','famas','m249','l85a2'}
...
io.stderr:write("rebalance.lua is working", "\n")
